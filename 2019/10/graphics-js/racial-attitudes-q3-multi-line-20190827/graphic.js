...
var formatData = function() {
  DATA1.forEach(function(d) {d.date = new Date(d['date'], 0, 1);});
  DATA2.forEach(function(d) {d.date = new Date(d['date'], 0, 1);});
  DATA3.forEach(function(d) {d.date = new Date(d['date'], 0, 1);});


  // Restructure tabular data for easier charting.
  for (var column in DATA1[0]) {
