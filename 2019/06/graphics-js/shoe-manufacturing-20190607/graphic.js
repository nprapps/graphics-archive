...
console.log(xScale(new Date(1990, 0, 1)));
...
//add annotation for first value
  ...
  annotation.append('line')
    ...
    .attr('x2', xScale(new Date(1991, 0, 1)))
    .attr('y1', yScale(76236))
    .attr('y2', yScale(76236));
  // annotation.append('circle')
  //   .attr('cx', xScale(new Date(1990, 0, 1)))
  //   .attr('cy', annotation.select('line').attr('y1'))
  //   .attr('r', 3);
  annotation.append('text')
    .text('76,237')
    .attr('x', xScale(new Date(1991, 5, 1)))
    .attr('y', yScale(75000))
    .attr('dx', -5)
