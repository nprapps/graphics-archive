...
var formatData = function() {
  ...
  for (var column in DATA[0]) {
    if (column == "Year" || column == "Month" || column == "date") continue;
    console.log(column);
...
var renderLineChart = function(config) {
  ...
  var yAxis = d3
    ...
    .scale(yScale)
   // .ticks(ticksY)
    .tickValues([250,275,300,325,350,375,400,425,450]);
  ...
  //add y-axis label at halfway point
  chartElement.append("text")
                 .attr("class", "axis axis-label")
                 .attr("x", 0)
                 .attr("y", yScale(min)/2)         
                 .attr("transform", `rotate(-90, 0, ${yScale(min)/2}) translate(-35,-40)`)
                 .html("Parts per million CO2");
