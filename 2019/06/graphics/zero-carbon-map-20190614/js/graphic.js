...
var renderStateGridMap = function(config) {
    ...
    if (LABELS['legend_labels'] && LABELS['legend_labels'] !== '') {
        ...
        //override sorting
        categories = ["Standard Enacted", "Standard Introduced","Non-binding goal enacted", "Non-binding goal introduced"];
    ...
    if (config['isNumeric']) {
        ...
        var colorScale = d3.scale.ordinal()
            .domain(categories)
            .range([ "#238b45", "#a1d99b",COLORS.blue2,COLORS.blue5])
    }
