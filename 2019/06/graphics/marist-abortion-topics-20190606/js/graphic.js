...
var renderDivergingBarChart = function(config) {
    ...
    if (config['title']) {
      var titleElement = containerElement.append('h4')
        .html(config['title'])
        .attr('style', 'margin: 0 0 11px 0');
      if (!isMobile) {
        titleElement.attr('style', 'margin: 0 ' + margins['right'] + 'px 11px ' + margins['left'] + 'px;');
      }
    }
