...
var renderStateGridMap = function(config) {
    ...
    // Set state colors
    config['data'].forEach(function(state) {
        if (state[valueColumn] !== null && state[valueColumn] != 40 && state[valueColumn] != 'no ban') {
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            ...
            .attr('class', function(d) {
              if (d[valueColumn] != null && d[valueColumn] != 40 && d[valueColumn] != 'no ban') {
                return 'category-' + classify(d[valueColumn]) + ' label label-active';
              } else {
                return 'label'
              }
            })
