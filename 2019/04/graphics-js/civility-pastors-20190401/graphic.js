...
var renderBarChart = function(config) {
  ...
  chartElement
    ...
    .attr("class", (d, i) => {
      var barClass = `bar-${i} ${classify(d[labelColumn])}`;
      barClass += (d[highlightColumn]) ? ' highlighted' : ''; 
      return barClass;
    });
  ...
  chartWrapper
    ...
    .attr("class", function(d) {
      return (d[highlightColumn]) ? `${classify(d[labelColumn])} highlighted` : classify(d[labelColumn]);
    })
    .append("span")
  ...
  chartElement
    ...
    .attr("y", (d, i) => i * (barHeight + barGap))
    .classed("highlighted", d => (d[highlightColumn]))
    .attr("dx", function(d) {
