...
var renderLineChart = function(config) {
  ...
  annotation.append('text')
    .text('Herding remains the primary occupation in many rural provinces.')
    .attr('x', xScale(new Date(2018, 0, 1)) + 10)
    .attr('y', function(){
      var y = yScale(65);
      if(isMobile.matches) y = yScale(65);
      return y;
    })
    .attr('dx', -5)
    .call(wrapText, 75, 13);
