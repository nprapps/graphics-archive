...
var renderGroupedStackedColumnChart = function(config) {
  ...
  var colorScale = d3.scaleOrdinal()
    ...
    .range([ COLORS.orange2, COLORS.orange3, COLORS.orange4, COLORS.orange5 ]);
  ...
  xScale.domain().forEach(function(c, k) {
    ...
    columns
      .selectAll(".x.axis.bars text")
      .attr("y", 0)
      .attr("dy", 15)
      .call(wrapText, xScaleBars.bandwidth(), 13);
