...
var renderLineChart = function(config) {
  ...
  var extent = [new Date(2017, 0, 1), dates[dates.length - 1]];
  ...
  chartElement
    ...
    .attr("y",function(d) {
      ...
      if (d.name === "Strengthened") {
        return yScale(lastItem(d)[valueColumn]) + -2
      } else if (d.name === "Weakened"){
