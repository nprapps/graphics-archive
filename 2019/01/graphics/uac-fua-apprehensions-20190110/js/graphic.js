...
var render = function(containerWidth) {
  if (!containerWidth) {
      if (document.body.classList.contains("childlink")) {
        containerWidth = 700;
      } else {
...
var renderLineChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ '#aaa', COLORS['teal2'], COLORS['teal5'] ]);
    ...
    var xAxis = d3.svg.axis()
        ...
        .tickFormat(function(d, i) {
            var month = getAPMonth(d);
            if (month == 'Jan.') {
                month += ' ' + fmtYearFull(d);
                // month += ' \u2019' + fmtYearAbbrev(d);
            }
            return month;
            // if (isMobile) {
