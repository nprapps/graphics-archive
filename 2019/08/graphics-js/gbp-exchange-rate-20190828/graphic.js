...
var dataSeries = [];
var annotations = [];
var skipLabels = ["date", "annotate", "x_offset", "y_offset", "_change"];
...
var renderLineChart = function(config) {
  ...
  var annotationWidth = 90;
  var annotationLineHeight = 15;

  var margins = {
    top: 5,
    right: annotationWidth,
    bottom: 20,
    left: 37
  };
  ...
  annotation
    ...
    .html(function(d) {
      ...
      var text = hasCustomLabel ? d.label + ' (' + fmtDateFull(d[dateColumn]) + ')' : fmtDateFull(d[dateColumn]);
