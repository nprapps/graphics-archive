...
var renderLineChart = function(config) {
  ...
  var yAxis = d3
    ...
    .ticks(ticksY)
    .tickFormat(function(d,i) {
      var unit = isMobile.matches ? "M" : " million";
      if (d != 0) {
        var roundedVal = (d / 1000000).toFixed(1);
        if (roundedVal.charAt(roundedVal.length - 1) == '0') {
  ...
  chartElement
    ...
    .text(function(d) {
      ...
      var label = d.name + ": " + (value / 1000000).toFixed(3) + ' million';
