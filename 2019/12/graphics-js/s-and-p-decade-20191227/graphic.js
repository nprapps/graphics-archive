...
var renderLineChart = function(config) {
  ...
  var max = Math.max.apply(null, ceilings) * 1.1;
  ...
  var yAxis = d3
    ...
    .scale(yScale)
    .ticks(ticksY)
    .tickFormat(d => d ? d.toLocaleString() : "");
  ...
  chartElement
    ...
    .text(function(d) {
      ...
      var label = (Math.round(value * 100) / 100).toLocaleString() + " points";
    ...
    .call(t => wrapText(t, margins.right, 14))
};
