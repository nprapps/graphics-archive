...
document.addEventListener('click', function (event) {
	...
	if (!event.target.matches('.sort-header')) return;
	...
	if (document.querySelector('[aria-sort="descending"]') && iterator === 0) {
		document.querySelector('[aria-sort="descending"]').removeAttribute("aria-sort");
        iterator++;
	} else {
		return
	}
