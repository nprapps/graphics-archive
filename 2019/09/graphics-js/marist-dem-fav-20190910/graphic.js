...
var render = function() {
  ...
  renderStackedBarChart({
    ...
    width,
    data: DATA,
    color: [ COLORS.orange2, COLORS.orange3, "#bbb"]
  });

  var container = "#stacked-bar-chart-two";
  var element = document.querySelector(container);
  var width = element.offsetWidth;
  renderStackedBarChart({
    container,
    width,
    data: DATA2,
    color: [ COLORS.blue2, COLORS.blue3, "#bbb"]
  });
...
var renderStackedBarChart = function(config) {
  ...
  // clear out fallback img.
  d3.select("#fallback-cont").html("");
  ...
  group
    ...
    .append("text")
    .text(function(d){
        if(d.val && isMobile.matches) return d.val;
        else if(d.val) return d.val + "%";
        else return null;
