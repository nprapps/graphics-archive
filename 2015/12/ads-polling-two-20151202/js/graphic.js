...
var formatData = function() {
    graphicData.forEach(function(d) {
        ...
        d['polling'] = +d['polling'];
        d['sept-spending'] = +d['sept-spending'];
        d['sept-polling'] = +d['sept-polling'];
    });
}
...
var renderLineChart = function(config) {
    ...
    var yColumn = 'polling';
    var xColumn2 = 'sept-spending';
    var yColumn2 = 'sept-polling';
