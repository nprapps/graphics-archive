...
var renderSlopegraph = function(config) {
    ...
    var min = d3.min(config['data'], function(d) {
        var row_min = d3.min([d[startColumn], d[endColumn]]);
        return Math.floor(row_min / roundTicksFactor) * roundTicksFactor;
    });

    var max = d3.max(config['data'], function(d) {
        var row_max = d3.max([d[startColumn], d[endColumn]]);
        return Math.ceil(row_max / roundTicksFactor) * roundTicksFactor;
    });
