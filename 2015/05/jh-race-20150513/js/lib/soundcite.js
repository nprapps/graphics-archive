    ...
    $(document).ready(function () {
        var SOUNDCITE_CONFIG = {
            update_playing_element: function(el, percentage) {
                $(el).css({
                    'background' : '-webkit-linear-gradient(left,  rgb(98, 182, 255, 0.76) ' + percentage + '%,  rgba(98, 182, 255, 0.2)' + (percentage + 1) + '%)',
                    'background' : 'linear-gradient(to right,  rgba(98, 182, 255, 0.76) ' + percentage + '%,  rgba(98, 182, 255, 0.2)' + (percentage + 1) + '%)'
                });
            }
        }
