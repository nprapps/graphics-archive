...
var graphic_data;
var graphic_data_url = 'hist-job-selects-shares-loss-hump.csv';
...
// hatching
  ...
  .append('path')
    ...
    .attr('stroke', function(d) {return colors['yellow3'];})
    .attr('stroke-width', 1);
...
if (!is_mobile) {
 ...
 linesAll = svg.append('g')
    .attr('class', 'lines')
    .selectAll('path')
    .data(d3.entries(formatted_data).filter(function(d){return d['key'] =="factory workers"}))
    .enter()
    .append('path')
        .attr('class', function(d, i) {
