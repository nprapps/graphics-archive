...
var renderLineChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['red4'], COLORS['yellow4'], COLORS['teal4'] ]);
    ...
    chartElement.selectAll('.y.axis .tick:nth-child(2) text')
        .html('<tspan y="-7">Population</tspan><tspan x="-10" y="7">group rate</tspan>')
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            ...
            .attr('y', function(d) {
                ...
                if (d['key'] == 'All violent crime') {
                    y -= 4;
                } else if (d['key'] == 'All property crime') {
                    y += 4;
                }
            ...
            .text(function(d) {
                ...
                var label = last[valueColumn].toFixed(1) + 'x';
