...
var formatPopulation = function(d) {
    // Millions
    return fmtComma(Math.round(d / 1000000).toFixed(0)) + 'M';
}
...
var renderStackedBarChart = function(config) {
    ...
    var ticksX = 5;
    var roundTicksFactor = 2000000000;
    ...
    var xAxis = d3.svg.axis()
        ...
        .tickFormat(function(d) {
            ...
            return Math.round(d / 1000000000).toFixed(0) + 'B';
        });
     ...
     var group = chartElement.selectAll('.group')
         ...
         .enter().append('g')
             .attr('class', function(d) {
                 return 'group year-' + d[labelColumn];
             })
    ...
    chartWrapper.append('ul')
        ...
        .append('li')
            ...
            .attr('class', function(d) {
                return 'year-' + d[labelColumn];
            })
            .append('span')
                .html(function(d) {
                    var label = d[labelColumn];

                    if (parseInt(d[labelColumn]) > 2015) {
                        label += '<br /><i>(projected)</i>';
                    }
