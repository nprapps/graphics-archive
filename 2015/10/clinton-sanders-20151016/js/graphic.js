            ...
            .append('span')
                ...
                chartElement.append('g')
                    ...
                    .append('text')
                        ...
                        .text(function(d) {
                            var amt = (100 * (d['values'][1]['val']) / (d['values'][0]['val'] + d['values'][1]['val']));
                            var toFixed = amt.toFixed(0);
                            var amt2 = (d['values'][0]['val'] + d['values'][1]['val']) / 1000000;
                            var toFixed2 = amt2.toFixed(1);
                            return '$' + toFixed2 + 'M, ' + toFixed + '% small donors';
                        })
                        .attr('x', function(d) {
