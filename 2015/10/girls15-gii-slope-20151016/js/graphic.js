...
var renderSlopegraph = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['teal5'], COLORS['teal5'], COLORS['teal5'], COLORS['teal5'], COLORS['orange4'], COLORS['orange4'], '#aaa' ]);
    ...
    chartElement.append('g')
        ...
        .append('text')
            ...
            .attr('y', function(d) {
                var y = yScale(d[startColumn]);

                if (d[labelColumn] == 'India') {
                    y -= 4;
                } else if (d[labelColumn] == 'Pakistan') {
                    y += 4;
                } else if (d[labelColumn] == 'World') {
                    if (isSidebar) {
                        y -= 2;
                    } else {
                        y -= 2;
                    }
                } else if (d[labelColumn] == 'Brazil') {
                    if (isSidebar) {
                        y += 3;
                    } else {
                        y += 2;
            ...
            .text(function(d) {
                if (isSidebar) {
                    return d[startColumn].toFixed(2);
                }

                return d[startColumn].toFixed(3);
            });
    ...
    chartElement.append('g')
        ...
        .append('text')
            ...
            .text(function(d) {
                if (isSidebar) {
                    return d[endColumn].toFixed(2);
                }

                return d[endColumn].toFixed(3);
            });
    ...
    chartElement.append('g')
        ...
        .append('text')
            ...
            .text(function(d) {
                var label = d[labelColumn];

                if (!isSidebar) {
                    label += ' (' + d['pct_change'].toFixed(1) + '%)';
                }
