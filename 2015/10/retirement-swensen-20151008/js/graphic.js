...
var formatData = function() {
    ...
    transposedData.push({ 'label': label, 'values': values });
    
    graphicData = null;
    graphicData = transposedData;
}
...
var renderStackedBarChart = function(config) {
     ...
     */
     ...
     var categories = d3.map(config['data'][0]['values'], function(d) {
        return d['name'];
     }).keys();
     
     var colorScale = d3.scale.ordinal()
         .domain(categories)
         .range([ COLORS['orange4'], COLORS['blue4'], COLORS['teal4'] ]);
