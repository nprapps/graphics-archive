...
var onWindowLoaded = function() {
    if (Modernizr.svg) {
        ...
        colorD3 = d3.scale.ordinal()
            .range([ colors['red2'], colors['blue1'] ])
            .domain('r', 'd');
...
var drawGraph = function(graphicWidth) {
    ...
    var xAxis = d3.svg.axis()
        ...
        .tickFormat(function(d, i) {
            ...
            if ((d > 800000) && (!isMobile)) {
                return (d.toFixed(1)/1000000) + ' million';
            }
            else if ((d <= 800000) && (!isMobile))
            {
                return fmtComma(d.toFixed(0)) + '';
            }

            else if ((graphicWidth <= MOBILE_THRESHOLD_TINY) && (i%2 == 0) && (d > 800000)) {
                return (d.toFixed(1)/1000000) + ' million';
            }
            else if ((graphicWidth <= MOBILE_THRESHOLD_TINY) && (i%2 == 0) && (d <= 800000)) {
                return fmtComma(d.toFixed(0)) + '';
    ...
    var labels = d3.select('#graphic').append('ul')
        ...
        .enter().append('li')
            ...
            .append('span')
                 .html(function(d) {
                    return '<a href="' + d['link'] + '" target="_blank">' + d['label'] + '</a>';
                });
}
