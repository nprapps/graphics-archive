...
var drawGraph = function(graphicWidth) {
    ...
    var xAxis = d3.svg.axis()
        ...
        .tickFormat(function(d,i) {
            var y;
            if ((graphicWidth <= MOBILE_THRESHOLD_TINY) && (i%2 == 0)){
            	y = '\u2019' + fmtYearAbbrev(d);
            }
            else if (isMobile && graphicWidth > MOBILE_THRESHOLD_TINY) {
                y = '\u2019' + fmtYearAbbrev(d);
            } else if (!isMobile){
                y = fmtYearFull(d);
            }
    ...
    svg.append('g')
        ...
        .enter().append('text')
            ...
            .text(function(d) { 
        		if (d < 1000000){
            		return '$0' + (d['amt'] / 1000000).toFixed(1) + ' million';
            	} else {
            		return '$' + (d['amt'] / 1000000).toFixed(1) + ' million';
            	}            		
            });
}
