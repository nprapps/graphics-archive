...
var formatData = function() {
    graphicData.forEach(function(d) {
        ...
        _.each(d, function(v, k) {
            if (_.contains(['Group', 'note', 'key', 'values'], k)) {
                return;
            }
...
var renderGroupedBarChart = function(config) {
    ...
    // shade China differently
    var chinaBars = chartElement.selectAll('.bars.china rect')
        .style('fill', function(d) {
            switch(d['label']) {
                case '2001':
                    return COLORS['red5'];
