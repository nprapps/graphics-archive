...
//            return d['amt'].length > 0;
    ...
    var yScale = d3.scale.linear()
        .domain([ 90, d3.max(d3.entries(formattedData), function(c) {
    ...
    chartElement.append('line')
        .attr('class', 'x grid grid-2009')
        .attr('x1', xScale(d3.time.format('%Y').parse('2009')))
        .attr('x2', xScale(d3.time.format('%Y').parse('2009')))
