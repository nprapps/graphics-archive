...
var formatData = function() {
    graphicData.forEach(function(d) {
        ...
        for (var key in d) {
            if (key == 'justice' || key == 'values' || key == 'wing') {
                continue;
            }
...
//                  console.log(d);
                 return 'group ' + classify(d[labelColumn]) + ' ' + classify(d['wing']);
             })
...
//                  console.log(d);
     ...
     chartElement.append('g')
         ...
         .append('text')
             .attr('x', function(d) {
                 return xScale(d['dissents'] + d['concurrences']);
             })
             .attr('y', function(d, i) {
             ...
             .attr('class', 'out')
             .text(function(d) {
                 return d['dissents'] + d['concurrences'] + ' total';
             });
