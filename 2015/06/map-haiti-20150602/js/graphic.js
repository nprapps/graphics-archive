...
var MAP_DEFAULT_SCALE = 5500;
var CITY_DOT_RADIUS = 3;
var MOBILE_THRESHOLD = 500;
var PRIMARY_COUNTRY = 'Haiti';
...
CITY_LABEL_ADJUSTMENTS['Les Cayes'] = { 'dy': 15 };
CITY_LABEL_ADJUSTMENTS['Gonaives'] = { 'text-anchor': 'end', 'dx': -6 };
CITY_LABEL_ADJUSTMENTS['Cap-Haitien'] = { 'dy': -6 };
CITY_LABEL_ADJUSTMENTS['Port-au-Prince'] = { 'text-anchor': 'end', 'dx': -6, 'dy': -6 };
CITY_LABEL_ADJUSTMENTS['Santo Domingo'] = { 'text-anchor': 'end', 'dx': -6, 'dy': -6 };

var COUNTRY_LABEL_ADJUSTMENTS = [];
COUNTRY_LABEL_ADJUSTMENTS['Cuba'] = { 'text-anchor': 'begin', 'dx': 25, 'dy': 12 };
COUNTRY_LABEL_ADJUSTMENTS['Haiti'] = { 'text-anchor': 'end', 'dx': 30, 'dy': -6 };
COUNTRY_LABEL_ADJUSTMENTS['Dominican Rep.'] = { 'text-anchor': 'middle', 'dy': -10 };
...
//     console.log('geoRivers', geoRivers);
//     console.log('geoLakes', geoLakes);
//     console.log('geoCities', geoCities);
//     console.log('geoNeighbors', geoNeighbors);
    ...
    svg.append('g')
        ...
        .enter().append('text')
            ...
            .attr('style', function(d) {
                return 'text-anchor: ' + positionLabel(COUNTRY_LABEL_ADJUSTMENTS, d['id'], 'text-anchor') + '';
            })
            .attr('dx', function(d) {
    ...
    var drLabel = d3.select('.country-labels text.' + classify('Dominican Rep.'));
    drLabel.text('');
    drLabel.append('tspan')
        .attr('x', 0)
        .attr('y', COUNTRY_LABEL_ADJUSTMENTS['Dominican Rep.']['dy'])
        .attr('dy', 0)
        .text('Dominican');
    drLabel.append('tspan')
        .attr('x', 0)
