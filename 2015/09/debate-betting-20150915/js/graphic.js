...
var formatData = function() {
    graphicData.forEach(function(d) {
        ...
        d['time'] = d3.time.format('%I:%M').parse(d['time']);
...
//            return d['amt'].length > 0;
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['#eee'], COLORS['#eee'], COLORS['#eee'], COLORS['#eee'], COLORS['#eee'], COLORS['#eee'], COLORS['#eee'], COLORS['red3'], COLORS['teal3'], COLORS['blue3'], COLORS['orange3'] ]);
    ...
    var legend = containerElement.append('ul')
        ...
        .enter().append('li')
            .attr('class', function(d, i) {
                return 'key-item key-' + classify(d['key']);
            });
    //
    // legend.append('b')
     ...
     * Create D3 axes.
     */
    var timeFormatter = d3.time.format('%I:%M');
     ...
     */
     tips = [
        ...
        {
            'labelX': d3.time.format('%I:%M').parse('08:45'),
            'labelY': 0.58,
            'targetX': d3.time.format('%I:%M').parse('08:59'),
            'targetY': 0.34,
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            .attr('class', function(d,i) {
                return 'label label-' + classify(d['key']);
            })
            .attr('x', function(d, i) {
