...
var renderStateGridMap = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        .domain(['All voting jurisdictions', 'Majority of jurisdictions', 'Minority of jurisdictions', 'All machines less than 10 years old'])
        .range([ COLORS['red3'], '#e5785f', '#f3ab9a', '#93caea']);
