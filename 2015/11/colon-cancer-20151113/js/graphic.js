...
var formatData = function() {
    graphicData.forEach(function(d) {
        ...
        for (var key in d) {
            ...
            if (key == 'education' || key == 'race' || key == 'values') {
                continue;
            }
...
var render = function(containerWidth) {
    ...
    var categories = d3.map(graphicData, function(d) {
        return d['race'];
    }).keys();
    ...
    for (c in categories) {
        ...
        var categoryData = graphicData.filter(function(d, i) {
