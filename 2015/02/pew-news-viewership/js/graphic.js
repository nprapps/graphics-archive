...
var drawGraph = function(graphicWidth) {
    ...
    var color = d3.scale.ordinal()
        .range([ colors['teal1'], colors['teal3'], colors['teal4'], colors['teal5'], colors['teal6'] ]);
    ...
    var lastDataPoint = GRAPHIC_DATA.length - 1;
...
//            return d['amt'].length > 0;
    ...
    svg.append('g')
        ...
        .append('text')
            ...
            .attr('x', function(d) { 
                return x(d['value'][lastDataPoint]['date']) + 6;
            })
            .attr('y', function(d) { 
                var ypos = y(d['value'][lastDataPoint]['amt']);
                switch(d['key']) {
                    case 'Total':
                        ypos -= 2;
                        break;
            ...
            .text(function(d) { 
                return d['value'][lastDataPoint]['amt'] + '% ' + d['key'];
            });
}
