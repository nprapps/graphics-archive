...
var drawGraph = function(graphicWidth) {
    ...
    var color = d3.scale.ordinal()
        .range([ colors['red4'], colors['teal4'], colors['blue3'], colors['orange3'], colors['teal3'] ]);
...
//            return d['amt'].length > 0;
    ...
    y.domain([ -.5, d3.max(d3.entries(formattedData), function(c) {
    ...
    // var annoteStart = svg.append("text")
    //     .attr("class", 'annotation group1')
    //     .attr('x', x(fmtYearFull.parse('1937')))
    //     .attr('y', y(2))
    //     .attr('dy', '2px')
    //     .attr('text-anchor', 'start')
    //     .text('Growth in 1% and 99% split in tk....')
    //     .style('font-size', annoteSize);


    // var annoteStart2 = svg.append("text")
    //     .attr("class", 'annotation group1')
    //     .attr('x', x(fmtYearFull.parse('1937')))
    //     .attr('y', y(2.6))
    //     .attr('dy', '2px')
