...
module.exports = function(config) {
  ...
  var yAxis = d3
    ...
    .tickFormat(function(d) {
      if (config.type == "vaccinations") {
        return d == 0 ? d : `${d/1000000} million`;
      } else {
        return fmtComma(d);  
      }
    })
  ...
  chartElement
    ...
    .text(function(d) {
      ...
      if (config.type == "deaths") {
        var label = `${fmtComma(value)} deaths per day`;
      } else if (config.type == "cases") {
        var label = `${fmtComma(value)} new cases per day`;  
      } else {
        var label = `${fmtComma(value)} vaccinations per day`;  
      }
  ...
  chartElement
    ...
    .attr("x1", xScale(new Date("1/20/2021")))
    .attr("x2", xScale(new Date("1/20/2021")))
    .attr("y1", yScale(0))
    .attr("y2", yScale(max));
  ...
  chartElement
    .append("text")
    .attr("class","note")
    .attr("x", xScale(new Date("1/20/2021"))-5)
    .attr("y", function() { return config.type == "vaccinations" ? yScale(max)+10 : yScale(max)+15 })
    .text("Inauguration")
