...
module.exports = function(config) {
  ...
  chartWrapper
    ...
    .attr("style", function(d, i) {
      ...
      //get bounding boxof label?

      return formatStyle({
        width: labelWidth - 7 + "px",
  ...
  barGroups
    ...
    // var el = document.getElementsByClassName('g bars')[0]
    // var labels = el.getElementsByClassName('value')[0]
    // labels.querySelectorAll('text').forEach(function(t){
