...
var { wrapText, COLORS, classify, makeTranslate } = require("./lib/helpers");
  ...
  var xAxis = d3
    ...
    .tickFormat(function(d, i) {
        ...
        if (monthDay(d).split(" ")[0]=='Jan.' ){
          if (isMobile.matches){
            return `${monthDay(d).split(" ")[0]} '21`
          }
          return `${monthDay(d).split(" ")[0]} 2021`
        } else if (monthDay(d).split(" ")[0]=='July' && i == 0) {
          if (isMobile.matches){
            return `${monthDay(d).split(" ")[0]} '20`
          }
          return `${monthDay(d).split(" ")[0]} 2020`
        }
