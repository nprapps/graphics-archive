kabul-airport-20210826
======================

The underlying Illustrator file for this graphic requires a large satellite image that has been synced separately. To retrieve it, run this on the command line:

```
node cli sync kabul-airport-20210826
```
