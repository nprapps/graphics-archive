...
var { yearAbbrev, yearFull, dayYear, dateFull, monthYear } = require("./lib/helpers/formatDate");
...
module.exports = function(config) {
  ...
  var yAxis = d3
    ...
    .tickFormat(function(d) {
      if (d ==0) return d;
      if (d == 10000) return '';
      return d/1000 + (isMobile.matches ? 'M' : ' million');
  ...
  chartElement
    .append("text")
    .html(isMobile.matches ? '10M job openings' : '10 million job openings')
    .attr("x", d => isMobile.matches ? xScale(new Date(2010, 0, 1)) : xScale(new Date(2010, 2, 1)))
    .attr("y", 0)
  ...
  annotation
    ...
    .html(function(d) {
      ...
      var text = hasCustomLabel ? d.label : monthYear(d[dateColumn]);
      var value = (d[valueColumn]/1000).toFixed(2) + (isMobile.matches ? 'M' : ' million');
      return text + " " + value;
    })
