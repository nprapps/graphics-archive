...
module.exports = function(config) {
  ...
  var colorScale = d3
    .scaleOrdinal()
    .domain(config.data[2].values.map(d => d[nameColumn]))
      .range([COLORS.teal2, COLORS.teal5, COLORS.blue3, "#ccc"]);
  ...
  chartElement
    ...
    .text("Estimated gigatons of carbon dioxide generated, 1850-2021");
  ...
  group
    ...
    .enter()
    .append("text")
    .text(d => fmtComma(d.val ? d.val : null))
