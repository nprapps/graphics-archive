...
var renderSlopegraph = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['orange3'], COLORS['teal3'],'#ccc', COLORS['teal3'], COLORS['teal3']]);
    ...
    chartElement.append('g')
        ...
        .append('text')
            ...
            .attr('y', function(d) {
                if (d[startColumn] == 4.7) {
                  return yScale(d[startColumn]) - 5;
                }
                return yScale(d[startColumn]);
            })
    ...
    chartElement.append('g')
        ...
        .append('text')
            ...
            .text(function(d) {
                var sign = d["change"] > 1 ? "+" : "";
                var ptChange = Number(d["change"]).toFixed(0);
                return d[labelColumn] + " (" + sign + ptChange + " pts.)";
            })
            .call(wrapText, (margins['right'] - wrapLabel), 16);
}
