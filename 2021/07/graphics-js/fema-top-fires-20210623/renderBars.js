...
var renderBarChart = function(config) {
  ...
  var barHeight = 25;
  var barGap = 5;
  var labelWidth = isMobile.matches ? 135 : 175;
  var labelMargin = 6;
  var valueGap = 6;
  ...
  chartElement
    ...
    .attr("class", (d, i) => `bar-${i} ${d.year >= 2015 ? 'recent' : 'old'} ${classify(d[labelColumn])}`);
  ...
  chartElement
    ...
    .text(function(d) {
      var append = '';
      console.log(d[valueColumn] == 18804)
      if (d[valueColumn] == 18804) append = ' structures';
      return fmtComma(d[valueColumn]) + append;
    })
