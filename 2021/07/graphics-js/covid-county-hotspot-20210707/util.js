...
var hotspotsColorScheme = ["#fda762", "#e25609", "#7f2704"];
...
var getTimeStamp = function (date) {
  ...
  var day = `${getAPMonth(date)} ${date.getDate()}, ${date.getFullYear()}`;
...
// automatic data
var DATA_URL_JSON =
  "https://apps.npr.org/dailygraphics/data/jhu-covid-19/arcgis.json";
