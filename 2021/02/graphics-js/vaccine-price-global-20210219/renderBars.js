...
var renderBarChart = function(config) {
  ...
  //   .enter()
  //   .append("li")
  //   .attr("class", d => "key-item " + classify(d.cat));

  // legend.append("b").style("background-color", d => colorScale(d.cat));

  // legend.append("label").text(d => d.cat);
  ...
  chartElement
    ...
    .attr("class", "x grid")
    .attr("transform", makeTranslate(0, chartHeight))
    .call(xAxis.tickSize(-chartHeight, 0, 0)
    .tickFormat(""));
  ...
  chartElement
    ...
    .enter()
    .append("text")
    .text(d => "$"+d[valueColumn].toFixed(2))
