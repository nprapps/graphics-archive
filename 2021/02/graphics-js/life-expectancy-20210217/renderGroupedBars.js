...
module.exports = function(config) {
  ...
  var { labelColumn, valueColumn, diffColumn } = config;
  ...
  var xAxis = d3
    ...
    .scale(xScale)
    .ticks(ticksX)
    .tickFormat(d => d.toFixed(0) + " years");
  ...
  barGroups
    ...
    .append("text")
    .text(function(d) {
      var v = d[valueColumn].toFixed(1) + " years";

      if (d[valueColumn] > 0 && v == 0) {
        v = "<1";
      }

      if (d[labelColumn] == "2019") {
        return v;
      }
      return v + " (" + d[diffColumn] + " years)";
    })
