...
module.exports = function(config) {
  ...
  var colors = {"Black":COLORS.orange4,"Hispanic/Latinx":COLORS.orange4,"Asian":COLORS.orange4,"White":COLORS.teal4}
  var colorScale = d3
    .scaleOrdinal()
    .domain(
   ...
   var areaGen = d3
    ...
    .join("path")
      .attr("fill", function (d) {
        // if (config.category == 'Black'){
        //   return colorScale(d.key) + 'B3'
        // }
        
        return colorScale(d.key) + '73'
      })
      .attr("d", areaGen)
