...
module.exports = function(config) {
  ...
  var { labelColumn, nameColumn, theme } = config;
  ...
  var chartWrapper = containerElement
    .append("div")
    .attr("class", "graphic-wrapper " + classify(config.theme));
  ...
  group
    ...
    .enter()
    .append("text")
    .text(d => (Math.round(d.val*100) ? Math.round(d.val*100) + "%" : null))
