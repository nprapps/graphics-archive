...
var onWindowLoaded = function() {
  ...
  var data2 = formatData(window.DATA2);
  render(data,data2);

  window.addEventListener("resize", () => render(data,data2));
...
var render = function(data,data2) {
  ...
  // // Render the chart!
  // renderStackedColumnChart({
  //   container: "#stacked-column-chart2",
  //   width: document.querySelector("#stacked-column-chart2").offsetWidth,
  //   data: data2,
  //   labelColumn: "label"
  // });
