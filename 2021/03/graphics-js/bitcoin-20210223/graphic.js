...
var onWindowLoaded = function() {
  var { annotations, series, milestoneDates } = formatData(window.DATA);
  render(series, annotations, milestoneDates);
  window.addEventListener("resize", () => render(series, annotations, milestoneDates));
...
var formatData = function(data) {
  ...
  return { series, annotations, milestoneDates };
};

/*
 * Render the graphic(s).
 */
var render = function(data, annotations, milestoneDates) {
