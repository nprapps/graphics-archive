...
var formatData = function() {
  ...
  //console.log()
  for (var i = 0; i < 4; i++){
    DATA[i].values = [DATA[i].values[1],DATA[i].values[0],DATA[i].values[2],DATA[i].values[3],DATA[i].values[4]]
  //DATA[1].values = [DATA[1].values[1],DATA[1].values[0],DATA[1].values[2],DATA[1].values[3],DATA[1].values[4]]
  }
...
var render = function() {
  ...
  var colorScale = d3
    ...
    .range([ COLORS.teal3,COLORS.teal5, "#BEBEBE", COLORS.orange5,COLORS.orange3 ]);
  ...
  legend.append("label").text(d => d.slice(1));
  ...
  charts.forEach(function(d,i) {
    if (i === 0){
      containerElement.append('h3')
        .attr("class","mid-subhed")
        .text("Primary news source")
    }
    if (i === 4){
      // containerElement.append('hr')
...
var renderStackedBarChart = function(config) {
  ...
  //console.log(Object.keys(config.data[0]))
  //console.log();
  //config.data[0] = moveObjectElement('9', '', config.data[0]);

  //config.data[0] = Object.assign(objectOrder, config.data[0]);
  // config.data[0] = {
  //   "9": config.data[0]['9'],
  //   "8": config.data[0]['8'],
  //   "7 or 6": config.data[0]["7 or 6"],
  //   "5 or 4": config.data[0]['5 or 4'],
  //   "3 or fewer": config.data[0]['3 or fewer'],
  //   "chart": config.data[0]["chart"],
