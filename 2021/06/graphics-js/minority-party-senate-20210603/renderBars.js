...
var renderBarChart = function(config) {
  ...
  chartWrapper.append('h3').text('Population represented by:')
  ...
  ticks[ticks.length -1].innerHTML = currText + ' million';
  ...
  chartElement
    ...
    .enter()
    .append("text")
    .text(d => (d[valueColumn]/1000000).toFixed(2))
