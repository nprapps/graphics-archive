...
var renderStateGridMap = function(config) {
  ...
  if (config.isNumeric) {
    ...
    // noodling on colors here: https://gka.github.io/palettes/#/7|s|ae2503,e38d2c,f8e2ca|ffffe0,ff005e,93003a|1|1

    var colorScale = d3
      .scaleThreshold()
      // .range(['#a23520', '#b65228', '#c96e37', '#da8a4f', '#e9a76f', '#f4c498', '#f8e2ca'])
      .range(['#000','#ae2503', '#bf4b13', '#d06a2b', '#df8848', '#eba66c', '#f4c497', '#f8e2ca'])
      .domain(categories);
  ...
  chartElement
    ...
    .text(function(d) {
      ...
      if (state.usps == "OH") {
        suffix = "*";
      } else if (state.usps == "OK" || state.usps == "RI") {
        suffix = "**";
      }
