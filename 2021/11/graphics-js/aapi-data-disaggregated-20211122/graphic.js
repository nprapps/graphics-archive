...
var renderStackedBarChart = function(config) {
  ...
  if (config.title == "Overall" && config.showTitle) {
    containerElement.append('h1')
      .html(LABELS.headline_1);
  } else if (config.title == "Large" && config.showTitle) {
    containerElement.append('h1')
      .html(LABELS.headline_2);
  } else if (config.title == "Southeast" && config.showTitle) {
    containerElement.append('h1')
      .html(LABELS.headline_3);
  }
