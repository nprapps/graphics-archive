...
module.exports = function(config) {
  ...
  var aspectWidth = isMobile.matches ? 5 : 16;
  ...
  chartElement
    ...
    .enter()
    .append("text")
    .text(d => d[valueColumn] < 1000000 ? (d[valueColumn]/1000).toFixed(0) + "K" : ((d[valueColumn]/1000000).toFixed(1) + "M").replace(".0", ""))
    ...
    // add in extra x axis labels

    chartElement.append('text')
    .attr('x', xScale("Most likely"))
    .attr("dx", xScale.bandwidth()/2)
    .attr("y", chartHeight + margins.bottom - 4)
    .text("Worldwide deaths as of Jan. 1")
    .attr('class', 'extra-annots')
