...
var renderStackedBarChart = function(config) {
  ...
  var colorScale = d3
    ...
    .range([ COLORS.teal3, 'rgb(153, 153, 153)', "#777", COLORS.orange3 ]);
    // .range([ '#14716f', COLORS['teal4'], 'rgb(153, 153, 153)', "#777", COLORS['orange4'], '#d4842b']);
