...
var renderBarChart = function(config) {
  ...
  var barHeight = isMobile.matches ? 50 : 30;
  var barGap = 5;
  var labelWidth = isMobile.matches ? 140 : 200;
  var labelMargin = 10;
  var valueGap = 6;
  var marginRight = isMobile.matches ? 18 : 30;
  ...
  var units = isMobile.matches ? "M" : " million";
  ...
  if (config.title) {
    containerElement.append("h3")
      .text(config.title)
      .attr("style", "max-width: " + labelWidth + "px;");
  }
  ...
  chartElement
    ...
    .attr("class", (d, i) => `bar-${i} ${classify(d[labelColumn])} ${classify(d.chart)}`);
  ...
  var lbls = chartWrapper
    ...
    .attr("class", function(d) {
      return classify(d[labelColumn]) + " " + classify(d.chart);
    })
    .append("span");
  lbls.append("strong")
