...
module.exports = function(config) {
  // Setup
  var { labelColumn, nameColumn, totalColumn } = config;
  ...
  var legend = containerElement
    ...
    .attr("class", "key")
    .append("text")
    .attr("class", "key-prefix")
    .text("By share of population able to be vaccinated with")
    .append("g")
    .selectAll("g")
  ...
  //   //   if (d.val) {
  //   //     if (d.val >= 1000000000) {
  //   //       return (d.val / 1000000000).toFixed(1) + "B";
  //   //     } else {
  ...
  chartElement
    ...
    .append("text")
    .text(function(d) {
      // console.log(d[totalColumn]);
      return "Total: " + d[totalColumn] + "%";
    })
    .attr("x", d => xScale(d[totalColumn]) + valueGap)
