...
module.exports = function(config) {
  ...
  if (isMobile.matches) {
    document.querySelector(".x.axis .tick text").setAttribute("dx", "-6");
  }
  ...
  chartElement
    ...
    .attr("y", d => {
      var y = yScale(lastItem(d)[valueColumn]) + 3;
      if (labelYArray.some(py => Math.abs(y - py) < 10)) {
        y += 5;
      }
      labelYArray.push(y);
      return y;
