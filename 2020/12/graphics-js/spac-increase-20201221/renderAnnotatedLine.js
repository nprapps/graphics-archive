...
module.exports = function(config) {
  ...
  /*
  SPECIAL: Add the 2011 line
  */
    var x2011 = xScale(new Date(2011, 0, 1)) + .5;
    if (0) chartElement.append("line")
    .attr("class", "sec-regulation")
    .attr("x1", x2011)
    .attr("x2", x2011)
    .attr("y1", 0)
    .attr("y2", chartHeight);
  ...
  annotation
    ...
    .html(function(d) {
      ...
      return `${d.date.getFullYear()}: ${text}`;
    })
