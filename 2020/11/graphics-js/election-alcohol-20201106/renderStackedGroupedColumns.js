...
module.exports = function(config) {
  ...
  // chartElement
  // .selectAll(".x.axis.category .tick line")
  // .data(config.data.filter(d => d.category))
  // .attr("transform", makeTranslate(xScale(d), 0));
  ...
  // chartElement
  //     .append("line")
  //     .attr("class", "total-line zero-line")
  //     .attr("x1", xScale("Hispanic") - 4)
  //     .attr("x2", xScale("Hispanic") - 4)
  //     .attr("y1", 0)
  //     .attr("y2", chartHeight);
