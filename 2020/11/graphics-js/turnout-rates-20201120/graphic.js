...
var dataSeries = [];
var annotations = [];
var skipLabels = ["date", "annotate", "annotate_text", "x_offset", "y_offset", "align"];
...
var renderLineChart = function(config) {
  ...
  annotation
    ...
    .attr("class", d => d.annotate_text ? 'dots annotated' : 'dots')
  ...
  annotation
    ...
    .html(function(d) {
      ...
      var returnT = text + ": " + value + '%';
      if (fmtYearFull(d[dateColumn]) == '2020') returnT += '*';
      return returnT
    })
