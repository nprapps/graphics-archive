...
var renderLineChart = function(config) {
  ...
  chartElement
    ...
    .text(function(d) {
      ...
      if (!isMobile.matches) {
        return label = label + " of " + valueName(d);
      }
    ...
    .text(function(d) {
      var label = "County inmates";

      if (!isMobile.matches && lastItem(d)[valueColumn] == 33.13) {
        return label;
      }
