...
var renderBarChart = function(config) {
  ...
  chartElement
    ...
    .enter()
      .append("rect")
        ...
        .attr("class", (d, i) => `bar-${i} ${classify(d[labelColumn])} debate-${d.debate}`)
        // .transition(t)
        //   .attr("width", d => Math.abs(xScale(0) - xScale(d[valueColumn])));
  ...
  chartWrapper
    ...
    .attr("class", function(d) {
      return classify(d[labelColumn]) + ' debate-' + d.debate;
    })
    .append("span")
  ...
  chartElement
    ...
    .attr('class', d => classify(d[labelColumn]) + ' debate-' + d.debate)
