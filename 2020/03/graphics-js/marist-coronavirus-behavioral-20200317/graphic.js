...
// var charts = ['travel', 'eating', 'crowd'];
...
var render = function() {
var container = "#bar-chart-travel";
...
var container = "#bar-chart-eating";
var element = document.querySelector(container);
var width = element.offsetWidth;
renderStackedBarChart({
  container,
...
var renderStackedBarChart = function(config) {
  ...
  group
    ...
    .enter()
    .append("text")
    .text(d => (d.val ? d.val.toFixed(0) + "%" : null))
    .attr("class", d => classify(d.name))
