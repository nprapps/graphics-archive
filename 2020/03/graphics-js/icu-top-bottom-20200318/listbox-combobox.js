...
aria.ListboxCombobox.prototype.setupEvents = function () {
  ...
  this.listbox.addEventListener("mousedown", this.setMouse.bind(this));
  this.listbox.addEventListener("mouseup", this.setMouse.bind(this));
...
aria.ListboxCombobox.prototype.setMouse = function(e) {
...
aria.ListboxCombobox.prototype.selectItem = function (item) {
  if (item) {
    ...
    var event = new CustomEvent("selectAutoComplete");
...
aria.ListboxCombobox.prototype.checkHide = function (evt) {
  if (evt.target === this.input || this.combobox.contains(evt.target) || this.listbox.contains(evt.target)) {
    return;
  }
  this.hideListbox();
};
...
aria.ListboxCombobox.prototype.checkSelection = function (e) {
  // suppress blur behavior if it's due to a click in the list
