...
module.exports = function(config) {
  ...
  // var ticksX = config.data[0].values.length;
  var ticksX = 5;
  var ticksY = 4;
  ...
  chartElement
    ...
    //   var thisEnergy = config.data[i];
    //   console.log(thisEnergy)
    //   chartElement.selectAll("circledot." + classify(thisEnergy.name))
    //     .data(thisEnergy.values)
    //     .enter()
    //     .append("circle")
    //     .attr("cx", d=> xScale(d.date))
    //     .attr("cy", d=> yScale(d.amt))
    //     .attr("class", d => "circledot " + classify(thisEnergy.name))
    //     .attr("r", dotRadius)
    // }
