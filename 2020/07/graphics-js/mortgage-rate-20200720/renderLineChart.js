...
module.exports = function(config) {
  ...
  var xAxis = d3
    ...
    .scale(xScale)
    .ticks(ticksX)
    .tickFormat(d => getAPMonth(d) + " " + yearFull(d));
  ...
  chartElement
    ...
    .text(function(d) {
      ...
      if (!isMobile.matches && d.name != "15-year fixed-rate mortgages") {
        label = getAPMonth(item[dateColumn]) + " " + item[dateColumn].getDate() + ": " + label;
      }
