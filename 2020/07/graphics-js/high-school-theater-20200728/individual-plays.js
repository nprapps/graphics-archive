...
// Global vars
var activePlay = 'You Can\'t Take It With You';
var pymChild = null;
var filteredData = [];
...
var playIndex = [];
var ranksShown = 15;
var years = [ 1940, 1950, 1960, 1970, 1980, 1990, 2000, 2010, 2020 ];
...
var render = function() {
  ...
  // make play drop-down
  var playSelectorWrapper = d3.select('#play')
    .html('')
    .append('div')
  ...
  // Render the chart!
  var chartContainerElement = d3.select('#play')
    .append('div')
    .attr('id', 'ratings');
