...
var renderBarChart = function(config) {
  ...
  chartElement
    ...
    .attr("class", (d, i) => `bar-${i} ${classify(d[labelColumn])} ${ classify(d.world_bank) }`);
  ...
  chartWrapper
    ...
    .attr("class", d => `${classify(d[labelColumn])} ${ classify(d.world_bank) }`)
    .append("span")
  ...
  chartElement
    ...
    .enter()
    .append("text")
    .text(d => (d[valueColumn] / 1000000).toFixed(2) + " million")
