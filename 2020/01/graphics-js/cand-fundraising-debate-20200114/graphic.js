...
var pymChild;
var skipLabels = ["Group", "key", "values","Type"];
...
var formatData = function() {
  DATA.forEach(function(d) {
    ...
    Object.keys(d).forEach(function(k) {
      ...
      d.values.push({ label: k, amt: +v, type: d.Type });
      delete d[k];
    });
...
var renderGroupedBarChart = function(config) {
  ...
  var colorScale1 = d3
    ...
    .range([COLORS.blue5, COLORS.blue3]);
...
var colorScale2 = d3
  ...
  legend.append("b").style("background-color", d => colorScale1(d[labelColumn]));
  ...
  barGroups
    ...
    .style("fill", function(d){      
      if (d.type == "R") {
        return colorScale2(d[labelColumn]) 
      } else {
        return colorScale1(d[labelColumn]) 
      }  
    })
