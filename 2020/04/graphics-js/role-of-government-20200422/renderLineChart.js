...
module.exports = function(config) {
  ...
  var recession_dates = [
    { 'begin': '1993-03-22', 'value': 49 },
    { 'begin': '2001-10-05', 'value': 50 },
    { 'begin': '2009-03-05', 'value': 47 }
    // { 'begin': '2007-12-01', 'end': '2009-06-01' },
    // { 'begin': '2001-09-11', 'end': '2002-12-31' },
    // { 'begin': '1990-07-01', 'end': '1991-03-01' }
  ];

  recession_dates.forEach(function(d) {
    // [ 'begin', 'end' ].forEach(function(v, k) {
      var [y, m, day] = d.begin.split("-").map(Number);
      d.begin = new Date(y, m - 1, day);
    // })
  });
  ...
  chartElement
    ...
    .attr("y", function(d, i) {
      if (i == 0) {
        return yScale(lastItem(d)[valueColumn]) + 1;
      } else {
        return yScale(lastItem(d)[valueColumn]) + 7;
      }
  ...
  chartElement.append('text')
    ...
    .attr('x', function(){
      ...
      return xScale(dates.begin) + 5;
    })
    .attr('y', chartHeight - 33)
    .text('Response to');
  chartElement.append('text')
    .classed('chart-label', true)
    .attr('x', function(){
