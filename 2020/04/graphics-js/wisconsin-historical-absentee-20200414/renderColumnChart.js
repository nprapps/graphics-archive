...
var { COLORS, makeTranslate, getAPMonth, fmtDate, classify } = require("./lib/helpers");
var legendNames = ["Spring election", "General election"]
...
module.exports = function(config) {
  ...
  chartElement
    ...
    .append("text")
    .attr("class", function(d) {
      return "values value-" + classify(d[labelColumn]);
    })
