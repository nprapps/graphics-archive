...
var mainProperty = "cardiovascularHospitalizationRate";
var pymChild;
...
function getFill(percent) {
  var teals = [COLORS.teal6, COLORS.teal5, COLORS.teal4, COLORS.teal3, COLORS.teal2, COLORS.teal1];

  var index = Math.floor((teals.length - 1) * percent/37.2);
  if (index < 0 || index > teals.length - 1) {
    return '#ddd';
  }
  return teals[index];
}
