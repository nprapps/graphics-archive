...
module.exports = function(config) {
  ...
  var colorScale = d3
    ...
    .domain(config.data[0].values.map(d => d[nameColumn]))
      .range([COLORS.orange3, COLORS.teal3, COLORS.blue3, "#ccc"]);
  ...
  chartElement
    .append("g")
    .attr("class", "x axis")
    .attr("transform", makeTranslate(-50, chartHeight))
    .call(xAxis);
  ...
  var group = chartElement
    ...
    .attr(
      "transform",
      (d, i) => "translate(-50," + i * (barHeight + barGap) + ")"
    );
  ...
  group
    ...
    .attr("dx", function(d) {
      ...
      return -(valueGap + 45) + 55;
    })
    .attr("dy", -10)
    .attr("class", d => (d.val == 80.4 ? "women" : "men"));
