...
// Global vars
var pymChild = null;
var skipLabels = ["label", "values", "offset", "chart","id"];
...
var renderStackedBarChart = function(config) {
  ...
  if (config.title == "Ford") {
    ...
    if (config.title == "Trump") {
      var additional = 0;
    } else if (config.title == "G. H. W. Bush" || config.title == "G. W. Bush"){
      var additional = 70;
    } else {
      var additional = 50;
    }
