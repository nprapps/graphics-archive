...
var projDate = new Date(2020, 6, 26);
...
module.exports = function(config) {
  ...
  annotation
    ...
    .html(function(d) {
      ...
      var bigText = d.series + ": " + fmtComma(value) + " deaths"
      if(text == 'Oct. 16') {
        bigText = "Today"
      }
      return bigText;
    ...
    .call(wrapText, isMobile.matches ? 100 : 120, annotationLineHeight)
    .attr("class", function(d, i) {
      return classify(d.series);
    });
};
