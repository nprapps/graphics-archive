...
var formatData = function() {
    ...
    DATA_HEROIN.forEach(function(d) {
        d['amt'] = +d['amt'];
    });
    DATA_FENTANYL.forEach(function(d) {
        d['amt'] = +d['amt'];
    });
}
...
var render = function(containerWidth) {
    ...
    var graphicWidth = isMobile ? containerWidth : containerWidth * 0.33;

    containerElement.append('div')
        .attr('class', 'graphic')
        .attr('id', 'totals-chart');

    containerElement.append('div')
        .attr('class', 'graphic')
        .attr('id', 'heroin-chart');

    containerElement.append('div')
        .attr('class', 'graphic')
        .attr('id', 'fentanyl-chart');

    // Render the chart!
    renderColumnChart({
        container: '#totals-chart',
        width: graphicWidth,
     ...
     */
        ...
        var xAxis = d3.svg.axis()
            ...
            .tickFormat(function(d, i) {
                if (containerWidth <= 700 && containerWidth >= MOBILE_THRESHOLD) {
