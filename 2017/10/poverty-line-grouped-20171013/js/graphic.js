...
var renderGroupedBarChart = function(config) {
    ...
    var firstBarOffset = 30;

    var chartXOffset = 55;
    config['width'] -= chartXOffset - 50;
    ...
    chartElement.append('g')
        .attr('class', 'x axis')
        .attr('transform', makeTranslate(chartXOffset, chartHeight))
        .call(xAxis);
    ...
    var barGroups = chartElement.selectAll('.bars')
        ...
        .append('g')
            ...
            .attr('transform', function(d, i) {
                if (i == 0) {
                    return makeTranslate(chartXOffset, firstBarOffset);
                }
                return makeTranslate(chartXOffset, (groupHeight + barGap) * i);
            });
    ...
    barGroups.append('g')
        ...
        .append('text')
            .text(function(d,i) {
                ...
                if (i%2 == 1){
                  d3.select(this).classed('out-bold', true);
                }
                else{
                  d3.select(this).classed('out-norm', true);
                }
