...
var pymChild = null;
var isMobile = false;
var skipLabels = [ 'label', 'values', 'Awaiting nomination num', 'Awaiting confirmation num', 'Confirmed num', 'No nominee num', 'Sum', 'Perc sum', 'Total'];
...
var renderStackedBarChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['red3'], COLORS['orange3'], COLORS['teal3'], '#ccc' ]);
