...
var renderStateGridMap = function(config) {
    ...
    if (config['isNumeric']) {
        ...
        var colorScale = d3.scale.ordinal()
            .domain(categories)
            // .range([COLORS['orange6'], COLORS['orange5'], COLORS['orange4'], COLORS['orange3'], COLORS['orange2'], COLORS['orange1']]);
            .range([COLORS['orange1'], COLORS['orange2'], COLORS['orange3'], COLORS['orange4'], COLORS['orange5']]);
    } else {
        // Define color scale
        var colorScale = d3.scale.ordinal()
            .domain(categories)
            .range([COLORS['red3'], COLORS['yellow3'], COLORS['orange3'], COLORS['orange3'], COLORS['teal3']]);
    }
