 ...
 */
 var render = function(containerWidth) {
    ...
    RESULTS_PROPERTY.forEach(function(d,i) {
        renderResults(resultsData[d], d);
    })
...
var renderResults = function(graphicData, race) {
    ...
    var containerElement = d3.select(CONTAINER[race]);
