...
var renderStateGridMap = function(config) {
    ...
    if (config['isNumeric']) {
        ...
        var colorScale = d3.scale.ordinal()
            ...
            // .range([ COLORS['orange5'], COLORS['orange4'], COLORS['orange3'], COLORS['orange2'], COLORS['orange1'] ]);
            .range([ '#f5d6b0','#ebad6f','#d7853e','#bd5e1a','#a03800' ]);

    } else {
        // Define color scale
        var colorScale = d3.scale.ordinal()
            .domain(categories)
            .range([COLORS['red3'], COLORS['yellow3'], COLORS['blue3'], COLORS['orange3'], COLORS['orange3']]);
    }
