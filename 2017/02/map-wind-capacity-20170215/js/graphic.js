...
var renderStateGridMap = function(config) {
    ...
    if (config['isNumeric']) {
        ...
        var colorScale = d3.scale.ordinal()
            .domain(categories)
            // .range([ '#ddd', COLORS['teal6'], COLORS['teal4'], COLORS['teal3'], COLORS['teal2'], COLORS['teal1'] ]);
            // .range([ '#ddd', '#d3eaf7','#98c4e3','#669ec3','#40799c','#28556f' ]);
    ...
    chartElement.select('path.state-north-carolina').moveToFront()
        .attr('class', 'active');
}
