...
var renderColumnChart = function(config) {
    ...
    chartElement.selectAll('.x.axis text')
        .attr('dy', 0)
        .attr('y', 18)
        .call(wrapText, xScale.rangeBand(), 11);
    ...
    annot.append('text')
        .text('Cut caregivers')
        .attr('x', xScale(config['data'][0][labelColumn]))
        .attr('y', 20)
        .attr('class', 'header decrease');
    annot.append('text')
        .text('Added caregivers')
        .attr('x', xScale(config['data'][8][labelColumn]) + xScale.rangeBand())
        .attr('y', 20)
        .attr('class', 'header increase');
}
