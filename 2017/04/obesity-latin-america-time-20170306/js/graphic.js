...
var onWindowLoaded = function() {
    if (Modernizr.svg) {
        formatData(MEXICO_DATA, mexicoDataSeries);
        formatData(US_DATA, usDataSeries);
...
var render = function(containerWidth) {
    ...
    containerElement.append('div')
        .attr('class', 'graphic')
        .attr('id', 'mexico-chart')
        .attr('style', 'width: ' + graphicWidth + 'px;');

    // Render the chart!
    renderLineChart({
        container: '#mexico-chart',
        width: graphicWidth,
        data: mexicoDataSeries,
        chartHead: 'Mexico'
    });
...
var renderLineChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([COLORS['teal2'], COLORS['teal4'], '#aaa']);
