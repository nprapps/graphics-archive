...
var onWindowLoaded = function() {
    if (Modernizr.svg) {
        formatData(SYRIA_DATA, syriaDataSeries);
        formatData(SUDAN_DATA, sudanDataSeries);
...
var render = function(containerWidth) {
    ...
    // Render the chart!
    renderLineChart({
        container: '#syria-chart',
        width: graphicWidth,
        data: syriaDataSeries,
        chartHead: 'Syria'
    });

    renderLineChart({
        container: '#sudan-chart',
        width: graphicWidth,
        data: sudanDataSeries,
        chartHead: 'South Sudan'
    });
