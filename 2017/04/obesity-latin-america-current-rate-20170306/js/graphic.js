...
var pymChild = null;
var isMobile = false;
var skipLabels = [ 'label', 'values', 'diff', 'overweight_raw' ];
...
var formatData = function() {
    DATA.forEach(function(d) {
        ...
        for (var key in d) {
            ...
            var x1 = x0 + d[key];
            d['overweight_raw'] = +d['overweight_raw'];
...
var renderStackedBarChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['teal2'], COLORS['teal4'], '#ccc' ]);
        // .range(['#2A5352', '#5EB9B7', '#ccc']);
     ...
     */
     ...
     group.append('g')
        ...
        .enter().append('text')
            .text(function(d) {
                if (d['name'] == 'Overweight (Body Mass Index > 25)' && d['val'] != 0) {
    ...
    chartWrapper.append('ul')
        ...
        .append('li')
            ...
            .attr('class', function(d) {
                if (d[labelColumn] == 'U.S.' || d[labelColumn] == 'Global') {
                    return classify(d[labelColumn]);
                } else {
                    return classify(d[labelColumn]) + ' main-label';
                }
            })
            .append('span')
                .text(function(d) {
