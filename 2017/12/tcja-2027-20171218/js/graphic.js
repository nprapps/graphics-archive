...
var render = function(containerWidth) {
    ...
    containerElement.append('div')
        ...
        .attr('id', 'chart-dollars');

    containerElement.append('div')
        .attr('class', 'graphic-wrapper')
        .attr('id', 'chart-percent');

    var graphicWidth = isMobile ? containerWidth : containerWidth * .48;

    // Render the chart!
    renderBarChart({
        container: '#chart-dollars',
        width: graphicWidth,
        label: LABELS['label_dollars'],
        dataKey: 'dollars',
        maxKey: 'dollars',
        ...
        data: DATA,
        roundTicksFactor: 10000,
    });

    renderBarChart({
        container: '#chart-percent',
        width: graphicWidth,
        label: LABELS['label_percent'],
        dataKey: 'percent',
        maxKey: 'percent',
        valueFormatter: function(d) {
            return d.toFixed(1) + '%';
...
var renderBarChart = function(config) {
    ...
    var xAxis = d3.svg.axis()
        ...
        .tickFormat(function(d) {
            if (d == 0) {
                ...
                return config['valueFormatter'](d);
            }
        });
    ...
    chartElement.append('g')
        ...
        .append('text')
            .text(function(d) {
                return config['valueFormatter'](d[valueColumn]);
            })
            .attr('x', function(d) {
                return xScale(d[valueColumn]);
            })
