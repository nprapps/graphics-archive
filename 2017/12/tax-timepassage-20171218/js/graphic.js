...
var renderStackedBarChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['red3'], ['#e2772f'], ['#ea9e33'], COLORS['yellow3'] ]);
     ...
     */
     ...
     group.append('g')
        ...
        .enter().append('text')
            ...
            .attr('class', function(d) {
                var mobileClass = isMobile ? 'hidden ' : '';
                return mobileClass + classify(d['name']);
            })
            .attr('x', function(d) {
 				return xScale(d['x1']);
            })
        ...
        chartElement.append('g')
            ...
            .append('text')
                .text(function(d, i) {
                    if (i === 2) {
                        return d[valueColumn].toFixed(0) + ' days total (thus far)';
                    } else {
                        return d[valueColumn].toFixed(0) + ' days total';
                    }
                })
                .attr('x', function(d) {
