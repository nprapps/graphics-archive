...
var renderGroupedBarChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['red3'], COLORS['orange4'], COLORS['yellow4'], '#CCC' ]);
    /*
     ...
     * Render bar values.
     */
    var barValues = barGroups.append('g')
        .attr('class', 'value')
        .selectAll('text')
        .data(function(d) {
            return d['values'];
        ...
        .append('text')
            .text(function(d, i) {
                ...
                if (d[valueColumn] > 0 && d[valueColumn].toFixed(0) == 0) {
                    v = '<1%';
                }

                if (d['seriesIndex'] == 0) {
                    v = v + ' of ' + d[labelColumn];
                }
            ...
            .attr('dx', function(d) {
                ...
                // Positive case
                    ...
                    if (xStart + valueGap + textWidth > chartWidth && d['seriesIndex'] > 0) {
                        d3.select(this).classed('in', true)
            ...
            .attr('dy', function(d, i) {
                ...
                if (isMobile && d['seriesIndex'] == 0) {
                    offset = -8;
                }

                return (barHeight / 2) + 4 + offset;
            });

    if (isMobile) {
        barValues.call(wrapText, 80, 13);
    }
}
