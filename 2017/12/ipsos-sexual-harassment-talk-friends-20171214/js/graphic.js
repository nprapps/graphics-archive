...
var render = function(containerWidth) {
    ...
    var chartHeads = {
        'female': LABELS['headline_female'],
        'male': LABELS['headline_male']
    };

    var dataFilter = {
        'female': function(q) {
            return q.question === 'female';
        },
        'male': function(q) {
            return q.question === 'male';
        }
    };
...
var renderDivergingBarChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['teal3'], COLORS['teal5'], COLORS['teal6'], '#ccc' ]);
