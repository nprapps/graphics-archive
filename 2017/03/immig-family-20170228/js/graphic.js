...
var formatData = function() {
    _.each([ DATA, PARENTAL ], function(v, k) {
...
var render = function(containerWidth) {
    ...
    var parental = containerElement.append('div')
        .attr('class', 'chart parental');
    parental.append('h1')
        .html(LABELS['headline_2']);

    renderStackedBarChart({
        container: '.chart.parental',
        width: graphicWidth,
        data: PARENTAL,
        domain: [ 0, 80 ]
    });

    var marriage = containerElement.append('div')
        .attr('class', 'chart marriage');
    marriage.append('h1')
        .html(LABELS['headline']);

    // Render the chart!
    renderStackedBarChart({
        container: '.chart.marriage',
        width: graphicWidth,
        data: DATA,
        domain: [ 0, 80 ]
    });
