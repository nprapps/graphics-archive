...
var charts = ['overall', 'party', 'education', 'ideology'];
...
var renderDivergingBarChart = function(config) {
    ...
    if (d3.select('html').classed('promo')) {
        xDomain = [ -68, 60 ];
    }
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['orange3'], COLORS['orange5'], COLORS['teal5'], COLORS['teal3'], '#ccc', '#999' ]);

    /*
     * Render the legend.
     */
    if (config['chart'] == 'overall') {
        if (showFullLegend) {
