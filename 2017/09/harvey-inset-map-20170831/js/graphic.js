...
var renderLocatorMap = function(config) {
    ...
    // other cities
    var satelliteCities = chartElement.append('g')
        ...
        .enter()
            ...
            .attr('transform', function(d,i) {
                d['centroid'] = [ d['lon'], d['lat'] ];
                return 'translate(' + projection(d['centroid']) + ')'; }
            )
            .attr('r', 2)
    ...
    var satelliteLabels = chartElement.append('g')
