...
var renderLineChart = function(config) {
    ...
    var xScale = d3.time.scale()
        .domain([ d3.time.format('%Y').parse('1967'), d3.time.format('%Y').parse('2016') ])
        .range([ 0, chartWidth ])
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['teal4'], COLORS['teal3'] ]);
