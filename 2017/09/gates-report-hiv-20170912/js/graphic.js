...
var renderLineChart = function(config) {
    ...
    chartElement.select('.line.current-aid').moveToFront();
    ...
    chartElement.append('g')
        ...
        // var projectedTarget = chartElement.append('g')
        //     // .attr('class', 'projected')
        //     .selectAll('circle')
        //     .data(projected)
        //     .enter()
        ...
        //                 return xScale(d['end']);
        //             })
        //             .attr('cy', yScale(0.235))
        //             .attr('r', 3)
        //             .attr('fill', COLORS['teal3']);
        //
        // var projectedTargetText = chartElement.append('text')
        //     .data(projected)
        //     .attr('class','projectedTargetText')
        //     .text('Target: 0.2')
        //     .attr('x',function(d){ return xScale(d['end']) + 8; })
        //     .attr('y',yScale(0.235)+4);
}
