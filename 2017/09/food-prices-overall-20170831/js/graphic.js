...
var renderLineChart = function(config) {
    ...
    var fmtMonthFullYear = d3.time.format('%m/%Y');
    ...
    var xAxis = d3.svg.axis()
        ...
        .tickFormat(function(d, i) {
            if (isMobile) {
                return fmtMonthFullYear(d);
            } else {
                console.log(d);
                return fmtMonthFullYear(d);
                if (getAPMonth(d) == 'July') {
                    return fmtMonthFullYear(d);
                }
            }
     ...
     var lineLabel = chartElement.append('g')
        ...
        .enter().append('text')
            ...
            .html(function(d) {
                ...
                // return 'July &apos;17 ' + label + '%';
                return 'Current ' + label + '%';
            });

        if (isMobile) {
            lineLabel.call(wrapText, 50, 13);
        } else {
            lineLabel.call(wrapText, 70, 13);
        }
}
