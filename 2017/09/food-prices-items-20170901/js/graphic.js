...
var render = function(containerWidth) {
    ...
    if (containerWidth <= MOBILE_THRESHOLD) {
        ...
        isMobile = false;
        graphicWidth = Math.round((containerWidth / 3) - gutterWidth);
    }
    ...
    items.forEach(function(d,i) {
        ...
        var thisChart = containerElement.append('div')
            .attr('id', thisChartSlug + '-chart')
            .attr('class', 'chart ' + thisChartSlug)
        ...
        // Render the chart!
        renderColumnChart({
            container: '#' + thisChartSlug + '-chart',
            slug: thisChartSlug,
            width: graphicWidth,
            data: DATA,
            header: 'hdr_' + thisChartSlug,
...
var renderColumnChart = function(config) {
    ...
    // var containerElement = d3.select('#chart-wrapper');
    containerElement.html('');
    containerElement.append('h3').html(LABELS[config['header']]);
