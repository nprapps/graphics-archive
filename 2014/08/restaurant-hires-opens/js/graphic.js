...
var fmt_year_abbr = d3.time.format('%b-%y');
var fmt_year_full = d3.time.format('%b-%Y');
var graphic_data;
var graphic_data_url = 'restaurants-hires-opens2.csv';
...
function draw_graph(width) {
    var color = d3.scale.ordinal()
        .range([ colors['blue3'], colors['red2'], colors['blue3'], colors['orange3'], colors['teal3'] ]);
