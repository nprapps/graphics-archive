...
var BAR_GAP = 3;
var GRAPHIC_DATA = [
    { 'label': 'Age 62', 'amt': 1300 },
    { 'label': 'Age 63', 'amt': 1393 },
    { 'label': 'Age 64', 'amt': 1486 },
    { 'label': 'Age 65', 'amt': 1610 },
    { 'label': 'Age 66', 'amt': 1733 },
    { 'label': 'Age 67', 'amt': 1857 },
    { 'label': 'Age 68', 'amt': 2006 },
    { 'label': 'Age 69', 'amt': 2154 },
    { 'label': 'Age 70', 'amt': 2303 }
];
...
var drawGraph = function(graphicWidth) {
    ...
    var x = d3.scale.linear()
        .domain([ 0, d3.max(GRAPHIC_DATA, function(d) { 
            return Math.ceil(d['amt']/500) * 500; // round to next 500
        }) ])
        .range([0, width]);
