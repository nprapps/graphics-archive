...
var renderStackedBarChart = function(config) {
     ...
     */
     ...
     var colorScale = d3.scale.ordinal()
         ...
         .range([ COLORS['blue6'], COLORS['orange5'], COLORS['orange4'], COLORS['orange3'], COLORS['red4'], COLORS['red3'], COLORS['red2'], COLORS['red1'] ]);
