...
function render(container_width) {
    ...
    var newtext =  formatted_data
    ['New Textbooks Index']
    var total =  formatted_data['Total']
    ...
    draw_graph(container_width, newtext, 'New Textbooks Index');
    draw_graph(container_width, total, 'Total');
...
function draw_graph(width, graphic_data, name) {
