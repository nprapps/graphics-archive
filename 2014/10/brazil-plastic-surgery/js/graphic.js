...
var graphic_data = [
{"procedure":"Surgical","usa":45.9,"brazil":74.2},
{"procedure":"Face and head","usa":9.9,"brazil":18.9},
{"procedure":"Breast","usa":16.4,"brazil":25.7},
{"procedure":"Body/extremities","usa":14.0,"brazil":24.8},
{"procedure":"Miscellaneous","usa":5.7,"brazil":4.8},
{"procedure":"Nonsurgical","usa":80.5,"brazil":32.3}
];

var header_text = [ 'United States', 'Brazil' ];
...
function render(container_width) {
    ...
    var y = d3.scale.ordinal()
        .domain(graphic_data.map(function(d) { return d['procedure']; }))
    ...
    var group = svg.selectAll('.bars')
        ...
        .enter().append('g')
            .attr('class', function(d,i) {
                return 'bars ' + classify(d['procedure']);
            })
            .attr('transform', function(d) { 
                return 'translate(0,' + y(d['procedure']) + ')';
            });
    ...
    var labels = chart.append('ul')
        ...
        .enter().append('li')
            .attr('style', function(d,i) {
                ...
                s += 'left: ' + 0 + 'px; ';
                s += 'top: ' + y(d['procedure']) + 'px; ';
                return s;
            })
            .attr('class', function(d,i) {
                return classify(d['procedure']);
            })
            .append('span')
