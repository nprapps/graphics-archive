...
var graphic_data = [
    { 'key': '5–14 years', 'value': [{ 'date': '2000', 'amt': 1.2 }, { 'date': '2010', 'amt': 0.9 }] },
    { 'key': '15–24 years', 'value': [{ 'date': '2000', 'amt': 17.1 }, { 'date': '2010', 'amt': 16.9 }] },
    { 'key': '25–44 years', 'value': [{ 'date': '2000', 'amt': 21.3 }, { 'date': '2010', 'amt': 23.6 }] },
    { 'key': '45–64 years', 'value': [{ 'date': '2000', 'amt': 21.3 }, { 'date': '2010', 'amt': 29.2 } ]},
...
function render(container_width) {
    ...
    var margin = { top: 0, right: 15, bottom: 20, left: 80 };
        ...
        .append('ul')
            ...
            .enter().append('li')
                .attr('class', function(d, i) { 
                    return 'key-item key-' + i + ' ' + classify(d['date']);
                });
    legend.append('b')
