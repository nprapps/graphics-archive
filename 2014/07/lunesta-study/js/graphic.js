...
var graphic_data = [
    { 'group': 'Unpleasant taste', 'placebo': 6, 'lunesta': 26 },
    { 'group': 'Dizziness', 'placebo': 3, 'lunesta': 10 },
    { 'group': 'Drowsiness', 'placebo': 3, 'lunesta': 9 },
    { 'group': 'Dry mouth', 'placebo': 2, 'lunesta': 7 },
    { 'group': 'Nausea', 'placebo': 6, 'lunesta': 11 }
];

var header_text = [ 'People given a sugar pill', 'People given Lunesta (3mg nightly)' ];
...
function render(container_width) {
    ...
    var margin = { top: 0, right: 15, bottom: 20, left: 100 };
