...
var data = {
    'factors': [
        { 'label': 'Grants and scholarships', 'amt': 30 },
        { 'label': 'Parent income and savings', 'amt': 27 },
        { 'label': 'Student borrowing', 'amt': 18 },
        { 'label': 'Student income and savings', 'amt': 11 },
        { 'label': 'Parent borrowing', 'amt': 9 },
        { 'label': 'Relatives and friends', 'amt': 5 }
    ]
};
...
$(window).load(function() {
    ...
    function drawChart(id, width) {
        ...
        var margin = { top: 10, right: 7, bottom: 35, left: 100 };
