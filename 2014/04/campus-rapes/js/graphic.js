...
var graphic_data = [
    { "year": "2004", "reports": 2530 },
    { "year": "2005", "reports": 2535 },
    { "year": "2006", "reports": 2516 },
    { "year": "2007", "reports": 2532 },
    { "year": "2008", "reports": 2431 },
    { "year": "2009", "reports": 2370 },
    { "year": "2010", "reports": 2729 },
    { "year": "2011", "reports": 3119 },
    { "year": "2012", "reports": 3621 }
];
...
function render_chart(data, container_width) {
    ...
    var y = d3.scale.linear()
        ...
        .domain([0, d3.max(graphic_data, function(d) { 
            var n = parseInt(d.reports);
            return Math.ceil(n/1000) * 1000; // round to next 5
        })]);
    ...
    svg.append('g')
        ...
        .enter().append('text')
            ...
            .attr('y', function(d) { 
                return y(d.reports) + 20;
            })
            .attr('text-anchor', 'middle')
            .text(function(d) { 
                var comma_fmt = d3.format('0,000');
                return comma_fmt(d.reports);
            });
