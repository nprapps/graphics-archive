...
var graphic_data = [
{"region":"Carribbean","continent":"Latin America","rate":39,"laws":39},
{"region":"Central America","continent":"Latin America","rate":29,"laws":19},
{"region":"Eastern Africa","continent":"Africa","rate":38,"laws":30},
{"region":"Eastern Asia","continent":"Asia","rate":28,"laws":100},
{"region":"Eastern Europe","continent":"Europe","rate":43,"laws":85},
{"region":"Middle Africa","continent":"Africa","rate":36,"laws":0},
{"region":"Northern Africa","continent":"Africa","rate":18,"laws":6},
{"region":"Northern America","continent":"Northern America","rate":19,"laws":100},
{"region":"Northern Europe","continent":"Europe","rate":17,"laws":94},
{"region":"Oceania","continent":"Oceania","rate":17,"laws":75},
{"region":"South America","continent":"Latin America","rate":32,"laws":15},
{"region":"South-central Asia","continent":"Asia","rate":26,"laws":83},
{"region":"Southeastern Asia","continent":"Asia","rate":36,"laws":18},
{"region":"Southern Africa","continent":"Africa","rate":15,"laws":88},
{"region":"Southern Europe","continent":"Europe","rate":18,"laws":90},
{"region":"Western Africa","continent":"Africa","rate":28,"laws":0},
{"region":"Western Asia","continent":"Asia","rate":26,"laws":46},
{"region":"Western Europe","continent":"Europe","rate":12,"laws":100}
];

var labels = { 
	'left': 'Abortions per 1,000 women aged 15-44', 
	'bottom': 'Share of women living in areas',
	'bottom2': 'with so-called \u201Cliberal laws\u201D',
	'bottom3': '(as defined by the study\u2019s authors)' 
};

var trend_data = [[ 0, 32.9, 100, 21.3 ]];
...
function draw_graph(graphic_width) {
    ...
    margin = { top: 5, right: 25, bottom: 75, left: 45 };
    ...
    var x_label2 = svg.append('text')
    	.attr('class', 'axis label')
    	.attr('text-anchor', 'middle')
    	.attr('x', width/2 + margin['top'])
    	.attr('y', +x_label.attr('y') + 16)
    	.text(labels['bottom2']);
    
    var x_label3 = svg.append('text')
    	.attr('class', 'axis label')
    	.attr('text-anchor', 'middle')
    	.attr('x', width/2 + margin['top'])
    	.attr('y', +x_label2.attr('y') + 16)
    	.text(labels['bottom3']);
...
function on_mouseover(e) {
	if (!is_mobile) {
		...
		tooltip.html(function(d) {
				...
				t += '<strong>' + e['laws'] + '%</strong> of women live in countries with &ldquo;liberal&rdquo; abortion laws';
				return t;
			})
			.attr('style', function(d) {
				var dot_y = y(e['rate']) + margin['top'];
				var dot_x = x(e['laws']) + margin['left'];
				var tt_left;
				var tt_top;
				var tt_height = 105;
				var tt_width = 175;
