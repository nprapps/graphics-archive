...
var graphic_data = [
    { 'label': 'Help victims whose abuser tracked them using GPS', 'amt': 84.7 },
    { 'label': 'Help victims whose abuser eavesdropped using remote tools', 'amt': 75.0 },
    { 'label': 'Ask survivors to disable GPS on their devices', 'amt': 54.2 },
    { 'label': 'Have a policy against using Facebook on premises', 'amt': 47.2 }
];
