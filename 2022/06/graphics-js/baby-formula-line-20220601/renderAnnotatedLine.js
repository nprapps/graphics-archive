...
module.exports = function(config) {
  ...
  var abbottAnno = chartElement
    .append("g")
    .attr("class", "abbott-anno");
  ...
  abbottAnno
    ...
    .attr("x1", xScale(abbottDate))
    .attr("x2", xScale(abbottDate))
    .attr("y1", yScale(0))
    .attr("y2", yScale(80));
  ...
  abbottAnno
    ...
    .attr("x", xScale(abbottDate) + 5)
    .attr("y", yScale(80) + 15)
    .text("Feb. 17: Abbott recall")
    .call(wrapText, abbottWidth, 13);
