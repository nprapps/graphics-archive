...
var formatData = function() {
    DATA.forEach(function(d) {
        ...
        _.each(d, function(v, k) {
            ...
            d['values'].push({ 'label': k, 'amt': +v, 'year': k.split('Rate in')[1] });
            delete d[k];
        });
        ...
        .append('li')
            .attr('style', function(d,i) {
                ...
                return formatStyle({
                    ...
                    'height': ((barHeight * numGroupBars) + barGapInner) + 'px',
                    'left': '0px',
                    'top': top + 'px;'
                });
            })
    ...
    barGroups.append('g')
        ...
        .append('text')
            .text(function(d,i) {
                ...
                if (d3.select(this.parentNode).classed('group-0')) {
                    return v + ' in ' + d['year'];
                }
