...
var render = function(containerWidth) {
    ...
    var charts = _.pluck(DATA, 'category');
    charts = d3.set(charts).values();
    ...
    charts.forEach(function(d, i) {
        ...
        chartElement.append('h4')
            .html(LABELS['hed_chart']);
        ...
        // Render the chart!
        renderBarChart({
            container: '.chart.' + classify(d) + ' .chart-inner',
            width: graphicWidth,
            data: chartData,
            xDomain: [ 0, 50 ]
        });
