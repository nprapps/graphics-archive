...
montage -border 0 -geometry 1000x -tile $COUNT'x' -quality 85% $FOLDER'/frames/*.jpg' $FOLDER'/filmstrip-1000.jpg'
montage -border 0 -geometry 600x -tile $COUNT'x' -quality 85% $FOLDER'/frames/*.jpg' $FOLDER'/filmstrip-600.jpg'
montage -border 0 -geometry 375x -tile $COUNT'x' -quality 85% $FOLDER'/frames/*.jpg' $FOLDER'/filmstrip-375.jpg'
