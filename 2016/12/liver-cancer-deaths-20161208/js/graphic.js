...
var renderDotChart = function(config) {
    ...
    var chartHeight = ((barHeight + barGap) * config['data'].length) - (barGap / 2);
    ...
    /*
     * Render leading lines to chart.
     */
    chartElement.append('g')
        .attr('class', 'leading-lines')
        .selectAll('line')
        .data(config['data'])
        .enter()
        .append('line')
            ...
            .attr('y1', function(d, i) {
                return (i * (barHeight + barGap)) + dotRadius + 2;
            })
