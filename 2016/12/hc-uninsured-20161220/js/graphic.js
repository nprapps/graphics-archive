...
var renderLineChart = function(config) {
    ...
    annotations.append('line')
        .attr('x1', xScale(d3.time.format('%Y').parse('1965')))
        .attr('x2', xScale(d3.time.format('%Y').parse('1965')))
        .attr('y1', yScale(yScale.domain()[0]))
        .attr('y2', yScale(yScale.domain()[1]) + 45);
    annotations.append('text')
        .text('Medicare and Medicaid established')
        .attr('x', xScale(d3.time.format('%Y').parse('1965')))
        .attr('y', 15)
        .attr('dx', -4)
        .call(wrapText, 75, 12);
    ...
    annotations.append('line')
        ...
        .attr('y2', yScale(yScale.domain()[1]) + 45);
    annotations.append('text')
        .text('First Affordable Care Act open enrollment')
