...
montage -border 0 -geometry 960x -tile $COUNT'x' -quality 80% $FOLDER'/frames/*.jpg' $FOLDER'/filmstrip-1000.jpg'
...
#convert -background white -alpha remove -layers optimize-plus -delay 12x60 -resize 600 $FOLDER'/frames/*.jpg' -loop -reverse 0 $FOLDER'/filmstrip.gif'
