...
var renderLineChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['blue2'], COLORS['teal5'] ]);
    ...
    //     .attr('class', 'with-supers clinton')
    //     .attr('x', xScale(config['data'][0]['values'][42]['date']))
    //     .attr('y', yScale(2165))
    //     .attr('width', xScale(xScale.domain()[1]) - xScale(config['data'][0]['values'][42]['date']))
    //     .attr('height', yScale(1645) - yScale(2165))
    //     .attr('fill', colorScale('Clinton'));
