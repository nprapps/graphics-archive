...
var renderLineChart = function(config) {
    ...
    */
    ...
    var valuesShown = [
        config['data'][0]['values'][5],
        config['data'][0]['values'][15],
    ...
    chartElement.append('g')
        ...
        .enter().append('circle')
            ...
            .attr('fill', function(d) {
                return colorScale('Citizenship applications');
            })
            .attr('r', 4);
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            ...
            .attr('y', function(d) {
                return yScale(d['amt']) - 24;
            })
            .attr('dx', 4)
            .attr('dy', 0)
            .text(function(d) {
                return 'FY ' + fmtYearFull(d['date']) + ': ' + fmtComma(d['amt']);
            })
            .call(wrapText, 60, labelLeading);
}
