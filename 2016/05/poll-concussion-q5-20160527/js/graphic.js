...
var renderStackedBarChart = function(config) {
     ...
     */
     ...
     var colorScale = d3.scale.ordinal()
         .domain(d3.keys(config['data'][0]).filter(function(d) {
             return d != labelColumn && d != 'values' && d != 'category';
         }))
         .range([ COLORS['red4'], '#ccc' ]);

     var colorScaleTotal = d3.scale.ordinal()
         .domain(colorScale.domain())
         .range([ COLORS['red2'], '#aaa' ]);
    ...
    chartWrapper.append('ul')
        ...
        .append('li')
            ...
            .attr('class', function(d) {
                return classify(d[labelColumn]) + ' ' + d['category'];
            })
            .append('span')
                .text(function(d) {
