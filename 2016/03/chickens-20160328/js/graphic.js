...
var render = function(containerWidth) {
    ...
    var gutterWidth = 22;
    var numColumns = dataSeries.length;
    ...
    if (containerWidth <= MOBILE_THRESHOLD) {
        ...
        isMobile = false;
        graphicWidth = Math.floor((containerWidth - (gutterWidth * (numColumns - 1))) / numColumns);
    }
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            ...
            .text(function(d) {
                ...
                var label = last[valueColumn].toFixed(config['decimals']) + ' ' + config['units'];
