...
var renderStackedColumnChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ '#ccc', COLORS['red1'], COLORS['red2'], COLORS['red3'], COLORS['red4'] ]);
    ...
    var xAxis = d3.svg.axis()
        ...
        .tickFormat(function(d, i) {
            if ((!isMobile && (i % 1 == 0)) || (isMobile && (i % 2 == 0))) {
                var fmtMD = d3.time.format('%b %e');
                var fmtMY = d3.time.format('%m/%Y');
                return fmtMY(d);
            }
        });
    ...
    bars.selectAll('text')
        ...
        .enter().append('text')
            ...
            .attr('y', function(d) {
                ...
                if (textHeight + valueGap > barHeight) {
