...
var renderSlopegraph = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['teal3'], COLORS['yellow3'], COLORS['blue3'], COLORS['orange3'], COLORS['red3'] ]);
    ...
    chartElement.append('g')
        ...
        .append('text')
            ...
            .call(wrapText, (margins['right'] - labelGap), 9);
}
...
var checkLabelOffsets = function(label, position) {
    if (typeof labelOffsets[label] != 'undefined') {
        return labelOffsets[label][position];
    } else {
        return 0;
    }
}
