...
var renderStackedBarChart = function(config) {
    ...
    //         .text(function(d) {
    //             if (d['val'] != 0) {
    //                 return '$' + (d['val']/1000000).toFixed(1) + 'M';
    //             }
    //         })
    //         .attr('class', function(d) {
    //             return classify(d['name']);
 ...
 // 				return xScale(d['x1']);
    ...
    chartWrapper.append('ul')
         ...
         */
        chartElement.append('g')
            .attr('class', 'endvalue total')
            .selectAll('text')
            .data(config['data'])
            .enter()
            .append('text')
                .text(function(d) {
                    return '$' + (d['Total']/1000000).toFixed(1) + 'M total';
                })
                .attr('x', function(d) {
        ...
        if (!isMobile) {
            chartElement.append('g')
                ...
                .append('text')
                    .text(function(d) {
                        return 'Dem.: $' + (d['democratic']/1000000).toFixed(1) + 'M | GOP: $' + (d['republican']/1000000).toFixed(1) + 'M';
                    })
                    .attr('x', function(d) {
                        return xScale(d['Total']);
                    })
