...
var renderStackedColumnChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['orange3'], '#999', '#bababa', '#dadada' ]);
    ...
    bars.selectAll('text')
        ...
        .enter().append('text')
            ...
            .attr('y', function(d) {
                ...
                return yScale(d['y1']) + textHeight + valueGap;
            })
    ...
    var annotations = chartWrapper.append('div')
        ...
        .attr('style', function() {
            ...
            s += 'bottom: ' + (chartHeight + margins['bottom'] + 9) + 'px;';
            return s;
        });
    ...
    annotations.append('div')
        ...
        .attr('style', function() {
            var s = '';
            s += 'width: ' + xScale.rangeBand() + 'px;';
            s += 'left: ' + xScale('U.S.') + 'px;';
            return s;
        });
    ...
    annotations.append('div')
        ...
        .attr('style', function() {
            var s = '';
            s += 'width: ' + ((xScale.rangeBand() * 3) + ((xScale.rangeBand() * 0.1) * 2)) + 'px;';
            s += 'left: ' + xScale('N.J.') + 'px;';
            return s;
        });
    ...
    annotations.append('div')
        ...
        .attr('style', function() {
            var s = '';
            s += 'width: ' + ((xScale.rangeBand() * 3) + ((xScale.rangeBand() * 0.1) * 2)) + 'px;';
            s += 'left: ' + xScale('Fla.') + 'px;';
            return s;
        });

    annotations.append('div')
        .text('Didn\'t need to expand Medicaid')
        .attr('style', function() {
            var s = '';
            s += 'width: ' + xScale.rangeBand() + 'px;';
            s += 'left: ' + xScale('Wis.') + 'px;';
            return s;
        });
}
