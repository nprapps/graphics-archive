...
var renderGroupedStackedColumnChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ ELEXCOLORS[0], '#15b16e', ELEXCOLORS[1] ]);
...
var renderStackedColumnChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ ELEXCOLORS[1], '#15b16e', ELEXCOLORS[0] ]);
    ...
    _.each(years, function(y) {
        ...
        var barXOffset = 0;
        if (y == '2016') {
            barXOffset = (barWidth - (barWidth * .5)) / 2;
            barWidth = barWidth * .5;
        }
     ...
     * Render values to chart.
     */
    var newBars = chartElement.selectAll('.bars.y-2016 g')
        .selectAll('text')
        .data(function(d) {
            return d['values'];
        })
