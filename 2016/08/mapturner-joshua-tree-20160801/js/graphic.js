...
var renderLocatorMap = function(config) {
     ...
     */
    chartElement.append('g')
        .attr('class', 'trees trees-1 primary')
        .selectAll('circle')
            .data(mapData['trees1']['features'])
        .enter().append('circle')
            .attr('cx', function(d) {
    ...
    chartElement.append('g')
        .attr('class', 'trees trees-2 primary')
        .selectAll('circle')
            .data(mapData['trees2']['features'])
        .enter().append('circle')
            .attr('cx', function(d) {
                var point = d['geometry']['coordinates'];
                return projection(point)[0];
     ...
     * Render a scale bar.
     */
    var scaleBarDistance = calculateOptimalScaleBarDistance(bbox, 20);
