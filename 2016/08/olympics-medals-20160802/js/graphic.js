...
var render = function(containerWidth) {
    ...
    charts.forEach(function(d,i) {
        ...
        chartElement.append('h3')
            .html(HEADERS[d]); // --> whyyy
        //
        // for (var country in HEADERS) {
        //   HEADERS[country].forEach(function(d) {
        //     chartElement.append('h3')
        //         .text(HEADERS[d]);
        //   })
        // }
        //
        // .text(d3.keys(HEADERS[d]));
        // for (var country in DATA) {
        //   DATA[country].forEach(function(d) {
...
var renderStackedColumnChart = function(config) {
    ...
    var xAxis = d3.svg.axis()
        ...
        .tickValues([
          ...
          d3.time.format('%Y').parse('1936'),
          d3.time.format('%Y').parse('1968'),
