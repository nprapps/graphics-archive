...
var renderLocatorMap = function(config) {
    ...
    chartElement.append('g')
        ...
        .enter().append('circle')
            ...
            .attr('class', function(d, i) {
                return 'quake ' + classify(d['id']) + ' ' + d['epicenter'];
            });
    chartElement.select('.epicenter').moveToFront();
    ...
    chartElement.append('g')
        ...
        .enter().append('circle')
            ...
            .attr('r', cityDotRadius * scaleFactor)
            .attr('class', function(d) {
                var c = 'place ';
                c += ' ' + classify(d['name']);
                c += ' scalerank-' + d['scalerank'];
                return c;
            });
