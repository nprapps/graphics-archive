...
var renderDotChart = function(config) {
    ...
    var max = d3.max(config['data'], function(d) {
        return Math.ceil(d['2014'] / roundTicksFactor) * roundTicksFactor;
    });
    // var max = 40;
    ...
    _.each(['shadow', 'value'], function(cls) {
        chartElement.append('g')
            ...
            .enter().append('text')
                ...
                .text(function(d) {
                    var diff = d['2014'] - d['2000'];
                    if (diff > 0) {
                        diff = '+' + diff.toFixed(1);
                    }
                    if (isMobile) {
                        return d['2014'].toFixed(1) + ' (' + diff + ' yrs )';
                    } else {
                        return d['2014'].toFixed(1) + ' (' + diff + ' years)';
                    }
                });
    });
}
