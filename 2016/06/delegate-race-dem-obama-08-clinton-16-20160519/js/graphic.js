...
var renderLineChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([COLORS['gray1'], COLORS['blue3']]);
    ...
    top_axis_label.text(top_axis_text + ' delegates')
