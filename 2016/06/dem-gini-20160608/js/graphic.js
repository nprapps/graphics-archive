...
var renderColumnChart = function(config) {
    ...
    var yAxis = d3.svg.axis()
        ...
        .orient('left')
        .ticks(ticksY)
        .tickValues([ -.06, -.04, -.02, 0, .02, .04, .06 ])
    ...
    chartElement.append('g')
        ...
        .append('rect')
            ...
            .attr('class', function(d) {
                return 'bar bar-' + d[labelColumn] + ' ' + d['winner'];
            });
    ...
    annotations.append('text')
        .html('&lsaquo; States with lower inequality')
        .attr('class', 'less')
        .attr('x', function() {
            if (isMobile) {
                var numScales = xScale.domain().length;
                return xScale(xScale.domain()[numScales - 1]);
            } else {
                return chartWidth / 2;
            }
        })
        .attr('y', yScale(-0.05));
    annotations.append('text')
        .html('States with higher inequality &rsaquo;')
        .attr('class', 'more')
        .attr('x', function() {
            if (isMobile) {
