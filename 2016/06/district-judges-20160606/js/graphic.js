...
var formatData = function() {
    DATA.forEach(function(d) {
        ...
        _.each(d, function(v, k) {
            if (_.contains(['Group', 'key', 'values', 'type'], k)) {
                return;
            }
...
var render = function(containerWidth) {
    ...
    var raceData = DATA.filter(function(d,i) {
        return d['type'] == 'race';
    })

    renderGroupedBarChart({
        container: '#grouped-bar-chart .race',
    ...
    var genderData = DATA.filter(function(d,i) {
        return d['type'] == 'gender';
    })

    renderGroupedBarChart({
        container: '#grouped-bar-chart .gender',
        width: containerWidth,
        data: genderData,
        xDomain: [0, 100]
    });
