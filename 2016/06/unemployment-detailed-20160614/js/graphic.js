...
var renderLineChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([COLORS['blue3'], COLORS['teal3']]);
    ...
    var dots_g = chartElement.append('g')
        .attr('class', 'dots')
        .selectAll('g.dots-wrap')
            .data(config['data'])
            .enter().append('g')
    ...
    dots_g.selectAll('circle')
        .data(function(d) {
            var group_data = [];
            valuesShown.forEach(function(k,v) {
                group_data.push(d['values'][k]);
            });
            return group_data;
        })
        .enter().append('circle')
