...
var render = function(containerWidth) {
    ...
    charts.forEach(function(d,i) {
        ...
        switch(d) {
            case 'gender':
                colorRange = [ COLORS['teal1'], COLORS['teal4'] ];
                break;
            case 'race':
                colorRange = [ COLORS['teal1'], COLORS['teal2'], COLORS['teal3'], COLORS['teal4'], COLORS['teal5'], '#bbb' ];
                break;
            case 'aba':
                colorRange = [ COLORS['teal1'], COLORS['teal3'], COLORS['teal5'], '#bbb' ];
                break;
            default:
                colorRange = [ COLORS['teal3'], COLORS['orange3'], COLORS['blue3'], '#ccc' ];
                break;
        }
