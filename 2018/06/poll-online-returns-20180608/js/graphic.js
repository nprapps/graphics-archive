...
var pymChild = null;
var isMobile = false;
var skipLabels = [ 'label', 'values', 'offset', 'label_fmt' ];
var charts = [];
...
var render = function(containerWidth) {
    ...
    charts.forEach(function(c,k) {
        ...
        if (c == 'returns2') { showLegend = false; }

        containerElement.append('div')
            .attr('class', 'chart ' + classify(c));

        renderDivergingBarChart({
            container: '#diverging-bar-chart .chart.' + classify(c),
...
var renderDivergingBarChart = function(config) {
    ...
    showFullLegend = config['showLegend'];
