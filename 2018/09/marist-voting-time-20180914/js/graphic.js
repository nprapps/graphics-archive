...
var render = function(containerWidth) {
    ...
    charts.forEach(function(v,k) {
        var chartWrapper = containerElement.append('div')
            .attr('class', 'chart-wrapper ' + classify(v));

        chartWrapper.append('h1')
            .html(LABELS['hed_' + v]);

        var subCharts = d3.keys(DATA[v][0]).filter(function(d) {
        ...
        subCharts.forEach(function(d,i) {
            ...
            // Render the chart!
            renderBarChart({
                container: '.' + classify(v) + ' .chart.c-' + i,
