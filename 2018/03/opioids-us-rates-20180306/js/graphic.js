...
var formatData = function() {
    ...
    for (var column in DATA[0]) {
        ...
        var thisSeries = column.split(' ')[1] == 'blacks' ? dataSeries[0] : dataSeries[1];
...
var render = function(containerWidth) {
    ...
    var groups = ['blacks', 'whites'];

    groups.forEach(function(val, i) {
        var groupChart = containerElement.append('div')
            .attr('id', 'line-chart-' + i)
            .attr('class', 'chart-wrapper grid-' + i);

        // Render the chart!
        var labelWidth = 22,
            gridColumns = 2,
            gutterWidth = 20,
            chartWidth = (containerWidth  - labelWidth - gutterWidth ) / gridColumns;

        groupChart.style('width', isMobile ? containerWidth + 'px' : i == 0 ? (chartWidth + labelWidth) + 'px' : chartWidth + 'px');

        renderLineChart({
            chartIndex: i,
            hed: 'Overdose deaths per 100,000, among&nbsp;' + val,
            container: '#line-chart-' + i,
            labelWidth: isMobile || i == 0 ? labelWidth : 0,
            width: isMobile ? containerWidth : i == 0 ? (chartWidth + labelWidth) : chartWidth,
