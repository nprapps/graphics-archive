...
var renderLineChart = function(config) {
    ...
    var xAxis = d3.svg.axis()
        ...
        .tickFormat(function(d, i) {
            if (isMobile) {
                return 'Q' + getQuarter(d) + ' ' + '\u2019' + fmtYearAbbrev(d);
            } else {
                return 'Q' + getQuarter(d) + ' ' + fmtYearFull(d);
            }
        });
    ...
    function adjustLabelPositions(label0, label1) {
    ...
    var label0 = d3.select(valueLabels[0][0]),
        label1 = d3.select(valueLabels[0][1]),
        label2 = d3.select(valueLabels[0][2]);

    adjustLabelPositions(label0, label1);
    adjustLabelPositions(label1, label2);

    label0.attr('y', +label0.attr('y') - 4);
}
