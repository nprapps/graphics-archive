...
var renderLineChart = function(config) {
    ...
    xScale.domain([ d3.time.format('%m/%d/%y').parse('1/1/17'), d3.time.format('%m/%d/%y').parse('7/11/18') ]);
    ...
    var colorScale = d3.scale.ordinal()
        ...
        // .range([ COLORS['teal2'], COLORS['teal3'], COLORS['teal4'], COLORS['teal5'], '#999' ]);
        .range([ '#d8472b','#e06b3c','#e68c4e','#eaaa61', '#999' ]);

        // colors: http://gka.github.io/palettes/#colors=#D8472B,#EAAA61|steps=4|bez=1|coL=1
