...
var renderLineChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([COLORS['red4'], COLORS['teal5'], COLORS['teal3'], COLORS['teal6'], COLORS['teal3']]);
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            ...
            .attr('x', function(d, i) {
                ...
                if (d['values'][d['values'].length - 8]['amt'] >= 9) {
                    xPlace = xScale(d['values'][d['values'].length - 8][dateColumn]) + 50;
                    yPlace = yScale(d['values'][d['values'].length - 8][valueColumn]) - 30;
                }
            ...
            .html(function(d) {
                ...
                if (label > 0) {
                    label = d['name'] + " rose " + Math.abs(label)  + " percentage points";
                } else {
                    label = d['name'] + " fell " + Math.abs(label)  + " percentage points";
                }   
    ...
    //     .attr("class", "blurb")
    //     .append("text")
    //     .html("From 1987 to&nbsp;2017, the homeownership rate for..."); 

    $('.blurb').css({"left": xPlace, "top": yPlace - 40, "width": chartWidth/3});   
    ...
    chartElement.append('text')
        ...
        .attr('x', function() {
            ...
            return xScale(dates['begin']) + ((xScale(dates['end']) - xScale(dates['begin'])) / 2) + (margins['left']/3);
        })
        .attr('y', 14)
        .text('Recession');
