...
var renderDotChart = function(config) {
    ...
    $('.grid .tick:nth-child(4) line').css({'stroke': '#666', 'stroke-width': '1.5px'});
    ...
    chartElement.select('.margin-2008')
        .selectAll('circle')
        .style({'fill': COLORS['blue5'], 'stroke': '#fff', 'stroke-width': '1px'});

    chartElement.select('.special-election')
        .selectAll('circle')
    ...
    _.each(['shadow', 'value'], function(cls) {
        ...
        .enter().append('text')
            ...
            .attr('dx', function(d,i) {
                ...
                var additional = (pClass == "special-election") ? 5 : 0;
        ...
        .append('li')
            ...
            .append('span')
                .html(function(d) {
                    ...
                    if (d['label'] == 'NY-20' || d['label'] == 'FL-19') {
