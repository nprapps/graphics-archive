...
if (isMobile){ticksX = 2;}
    ...
    // define categories and colorscale
    var categories = _.uniq(_.pluck(config['data'], 'chart')).sort();
    var colorScale = d3.scale.ordinal()
        .domain(categories)
        .range([ COLORS['orange3'], COLORS['blue1'], '#a4a8ad', COLORS['blue5'] ]);
