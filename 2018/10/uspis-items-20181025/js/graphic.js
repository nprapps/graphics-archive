...
var renderColumnChart = function(config) {
    ...
    var t = textures.lines().thicker().stroke("white")
    ...
    chartElement.append("text")
        .attr("x", xScale(2011) + xScale.rangeBand())
        .attr('y', yScale(250) + 20)
        .attr("class", "no-data-text chart-label")
        .text(function() {
            if (isMobile) {
                return "No data"
            } else {
