...
var renderLocatorMap = function(config) {
    ...
    if (DATA_DISPLAY == 'choropleth') {
        if (DATA_POSITIONING == 'country') {
            ...
            var colorBins = _.uniq(_.pluck(config['data'], 'amt'));
            console.log(colorBins);
            var colorRange = [ '#DDD', COLORS['red2'], COLORS['red5'], COLORS['blue3'] ];
            var colorNoData = '#DDD';
            ...
            //     .data(colorBins.filter(function(d,i) {
            //         return d != null;
            //     }))
            //     .enter().append('li')
            ...
            var countryLabels = chartElement.append('g')
                .attr('class', 'labels')
                .selectAll('text')
        ...
        if (!isMobile) {
            bubbles.on('mouseover', function(d) {
                    ...
                    tooltip.classed('active', true)
                        .text(d['name'] + ': ' + fmtComma(d['amt']) + ' cases')
                        .attr('style', function() {
