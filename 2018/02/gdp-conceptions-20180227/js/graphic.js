...
var recession_dates = [
    { 'begin': '07-1990', 'end': '01-1991' },
    { 'begin': '01-2001', 'end': '11-2001'},
    { 'begin': '11-2007', 'end': '04-2009'}
];
...
var formatData = function() {
    recession_dates.forEach(function(d) {
        d['begin'] = d3.time.format('%m-%Y').parse(d['begin']);
        d['end'] = d3.time.format('%m-%Y').parse(d['end']);
    });
