...
var renderLineChart = function(config) {
  ...
  var colorScale = d3.scaleOrdinal()
    ...
    .range([COLORS.orange3, COLORS.blue3]);
  ...
  var recessionGroup = chartElement.append("g")
    .attr("class", "recessions");
    
  recessionGroup.selectAll("rect")
    .data(recessions)
    .enter()
      .append("g")
  ...
  recessionGroup.selectAll(".recession")
    .append("text")
    .text("Recession")
    .attr("x", 4)
    .attr("y", 12)
  ...
  chartElement.append('g')
    ...
    .attr('y', function(d) {
      ...
      var close = labelPositions.filter(ly => Math.abs(ly - y) < 5).pop();
