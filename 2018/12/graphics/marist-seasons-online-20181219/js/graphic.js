    ...
    containerElement.html('');
     ...
     _.each(charts, function(d, i) {
        ...
        var chartElement = containerElement.append('div')
            .attr('class', 'chart chart-' + classify(d));

        // Render the chart!
        renderDivergingBarChart({
            container: '.chart.chart-' + d,
            chart: d,
            width: containerWidth,
            data: chartData,
            chartHead: LABELS['hdr_' + d],
...
var renderDivergingBarChart = function(config) {
     ...
     */
    var min = 40;//d3.min(config['data'], function(d) {
        //return d['offset'];     });
    ...
    var max = 80;//= d3.max(config['data'], function(d) {
        // console.log(d['values'][d['values'].length - 1]['x1']);
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ '#1a600a','#4ac12f','#8dd87c', '#7a7a7a',COLORS['teal3'], COLORS['orange3'], COLORS['orange3'], '#ccc', '#999' ]);
