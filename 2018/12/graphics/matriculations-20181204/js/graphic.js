...
var renderGroupedStackedColumnChart = function(config) {
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['blue5'], COLORS['blue2'] ]);
    ...
    // dividing line between race/ethnicity and gender bars
    var xLeft = xScale('African-American') + xScale.rangeBand();
    var xRight = xScale('Female');

    chartElement.append('line')
        .classed('divider', true)
        .attr('x1', (xLeft + ((xRight - xLeft) / 2)))
        .attr('x2', (xLeft + ((xRight - xLeft) / 2)))
        .attr('y1', -margins['top'])
        .attr('y2', chartHeight + margins['top'] + margins['bottom']);
}
