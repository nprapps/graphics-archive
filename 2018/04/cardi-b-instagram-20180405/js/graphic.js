...
var formatData = function() {
    DATA.forEach(function(d) {
        ...
        for (var key in d) {
            if (key != 'date' && d[key] != null && d[key] != 'null' && d[key].length > 0) {
                d[key] = +d[key];
            }
        }
    });
...
var renderLineChart = function(config) {
    ...
    annots.selectAll('text')
        ...
        .enter().append('text')
            ...
            .attr('x', function(d) {
                var imgOffset = d['alignment'] == 'start' ? annotImageMargin + 2 : -(annotImageMargin + 2);
    ...
    annots.select('text:first-child').call(wrapText, annotTextWidth - 70, 12);
