...
var renderLineChart = function(config) {
    ...
    containerElement.append('h3')
        .text('White ' + config['title'] + ' with a College Degree');
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            ...
            .attr('y', function(d) {
                var first = d['values'][0];
                var compare = d['values'][8];
                var offset = first[valueColumn] - compare[valueColumn] < 0 ? 14 : -6;
    ...
    chartElement.append('g')
        ...
        .enter().append('text')
            ...
            .attr('y', function(d) {
                var last = d['values'][d['values'].length - 1];
                var compare = d['values'][d['values'].length - 5];
                var offset = last[valueColumn] - compare[valueColumn] < 0 ? -6 : 12;

                if (config['container'] == '#chart-women') {
                    return yScale(last[valueColumn]) - offset + 8;
                } else {
