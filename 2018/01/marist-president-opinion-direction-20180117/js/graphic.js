...
var charts = [ 'overall', 'democrats', 'republicans', 'independents' ]; // Array to loop through to make multiple charts
...
var render = function(containerWidth) {
    ...
    var dataFilters = {
        'overall' : function(d) {
            return d.Chart === 'Overall';
        },
        'democrats' : function(d) {
            return d.Chart === 'Democrats';
        },
        'republicans' : function(d) {
            return d.Chart === 'Republicans';
        },
        'independents' : function(d) {
            return d.Chart === 'Independents';
        }
    };
