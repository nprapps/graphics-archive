...
var charts = ['the economy', 'foreign policy', 'race relations', "women's rights"];
...
var render = function(containerWidth) {
    ...
    var dataFilters = {
        'the economy' : function(d) {
            return d.chart === 'the economy';
        },
        'race relations' : function(d) {
            return d.chart === 'race relations';
        },
        "women's rights": function(d) {
            return d.chart === "women's rights";
        },
        'foreign policy' : function(d) {
            return d.chart === 'foreign policy';
        }
    };
    ...
    var colorScale = d3.scale.ordinal()
        ...
        .range([ COLORS['teal3'], '#7d7d7d', '#ccc', COLORS['orange3']]);
...
var renderStackedBarChart = function(config) {
    ...
    var mutedColorScale = d3.scale.ordinal()
        ...
        .range([ '#5aa09f', '#a9a9a9', '#d5d5d5', '#ecaa63' ]);
