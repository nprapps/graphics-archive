...
var renderDotChart = function(config) {
    ...
    chartElement.append('text')
        ...
        .text('Generic ballot preference around start of election year')
     ...
     */
     ...
     chartElement.append('rect')
        ...
        .attr('y', (4 * (barHeight + barGap)) - (barGap/2))
        .attr('height', chartHeight + barGap - (4 * (barHeight + barGap)) - (barGap/2))
        .attr('fill', '#f1f1f1');
