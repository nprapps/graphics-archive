...
var legendLabels = [ 'Urban residence', 'Rural residence' ];
var charts = ['No births','One birth','Two births','Three or more births'];
...
var render = function(containerWidth) {
    ...
    var dataFilter = {
        'No births': function(q) {
            return q.label === 'No births';
        },
        'One birth': function(q) {
            return q.label === 'One birth';
        },
        'Two births': function(q) {
            return q.label === 'Two births';
        },
        'Three or more births': function(q) {
            return q.label === 'Three or more births';
        }
    };
    ...
    charts.forEach(function(d) {
        ...
        var thisChartData = DATA.filter(dataFilter[d]);
...
var renderGroupedStackedColumnChart = function(config) {
    ...
    // Add header
    containerElement.append('h3').html(config['header']);
